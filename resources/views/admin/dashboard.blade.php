                            ...
                            <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                ...
                                <div class="mb-4 px-9">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <!--begin::Value-->
                                        <span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">GHc {{ $account->holding }}</span>
                                        <!--end::Value-->
                                    </div>
                                    <!--end::Info-->
                                    <!--begin::Description-->
                                    <span class="fs-6 fw-semibold text-gray-400">Total Balance in holding</span>
                                    <!--end::Description-->
                                </div>
                                <!--end::Statistics-->
                                <!--begin::Chart-->
                        ...
                        <div class="card card-flush h-md-50 mb-lg-10">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    <!--begin::Amount-->
                                    <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{ number_format($drivers) }}</span>
                                    <!--end::Amount-->
                                    <!--begin::Subtitle-->
                                    <span class="text-gray-400 pt-1 fw-semibold fs-6">Total Drivers</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            </div>
                    ...
                    <div class="col-md-4 col-xl-4 mb-5 mb-xl-10">
                        ...
                        <div class="card overflow-hidden h-md-50 mb-5 mb-xl-10">
                            ...
                            <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                ...
                                <div class="mb-4 px-9">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <!--begin::Value-->
                                        <span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">{{ number_format($orgs) }}</span>
                                        <!--end::Value-->
                                    </div>
                                    <!--end::Info-->
                                    <!--begin::Description-->
                        ...
                        <div class="card card-flush h-md-50 mb-lg-10">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    <!--begin::Amount-->
                                    <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2">{{ number_format($brokers) }}</span>
                                    <!--end::Amount-->
                                    <!--begin::Subtitle-->
                                    <span class="text-gray-400 pt-1 fw-semibold fs-6">Total Brokers</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            </div>
                        ...
                        <div class="card card-flush h-md-50 mb-lg-10">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <!--end::Amount-->
                                    <!--begin::Subtitle-->
                                    <span class="text-gray-400 pt-1 fw-semibold fs-6">New Senders This
                                        Month</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
