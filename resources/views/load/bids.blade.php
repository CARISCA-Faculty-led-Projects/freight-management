                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-end pe-0">
                                            ...
                                            <div class="d-flex justify-content-start flex-column">
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jesse
                                                    Anim</a>
                                                <span
                                        ...
                                        <td class="text-end pe-0">
                                            ...
                                            <div class="d-flex justify-content-start flex-column">
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jenny
                                                    Wilson</a>
                                                <span class="text-gray-400 fw-semibold d-block fs-7">Jess Fleet
                                                    Mangement Inc</span>
                                            </div>
                                        </td>
										<td class="text-end pe-0">
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-600 fw-bold fs-6">0087</span>
                                        </td>
                                        <td class="text-end pe-0">
                                            <span class="text-gray-600 fw-bold fs-6">GHS 389.89</span>
                                        </td>
                                        <td class="pe-0">
                                            <div class="d-flex align-items-center justify-content-end">

                                                <span class="text-gray-600 fw-bold d-block fs-6">GHS 500</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end pe-0">
                                            <div class="d-flex justify-content-start flex-column">
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">John
                                                    Smith</a>
                                                <span
                                        ...
                                        <td class="text-end pe-0">
                                            <div class="d-flex justify-content-start flex-column">
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Logistics
                                                    Hub</a>
                                                <span class="text-gray-400 fw-semibold d-block fs-7">Emily Carter</span>
                                            </div>
                                        </td>
										<td class="text-end pe-0">
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-600 fw-bold fs-6">0099</span>
                                        </td>
                                        <td class="text-end pe-0">
                                            <span class="text-gray-600 fw-bold fs-6">GHS 560.00</span>
                                        </td>
                                        <td class="pe-0">
                                            <div class="d-flex align-items-center justify-content-end">
                                                <span class="text-gray-600 fw-bold d-block fs-6">GHS 600</span>
                                            </div>
                                        </td>
                                        <td class="text-end">
                                            <a href="/load/bids"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end pe-0">
                                            <div class="d-flex justify-content-start flex-column">
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Alice
                                                    Johnson</a>
                                                <span
                                        ...
                                        <td class="text-end pe-0">
                                            <div class="d-flex justify-content-start flex-column">
                                                <a href="#"
                                                    class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Swift
                                                    Cargo</a>
                                                <span class="text-gray-400 fw-semibold d-block fs-7">David Smith</span>
                                            </div>
                                        </td>
										<td class="text-end pe-0">
                                            <span class="badge badge-danger">pending</span>
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-600 fw-bold fs-6">0055</span>
                                        </td>
                                        <td class="text-end pe-0">
                                            <span class="text-gray-600 fw-bold fs-6">GHS 450.00</span>
                                        </td>
                                        <td class="pe-0">
                                            <div class="d-flex align-items-center justify-content-end">
                                                <span class="text-gray-600 fw-bold d-block fs-6">GHS 500</span>
                                    ...
                                    <div class="d-flex fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            ...
                                            <label class="form-check-label" for="kt_modal_update_role_option_0">
                                                ...
                                                <div class="text-gray-600">Increase impression traffic onto the platform
                                                </div>
                                            </label>
                                            <!--end::Label-->
                                        </div>
                    ...
                    <div class="fv-row mb-8">
                        ...
                        <div class="d-none" data-kt-modal-bidding-type="crypto">
                            ...
                            <select name="currency_crypto" aria-label="Select a Coin"
                                ...
                                <option data-kt-bidding-modal-option-icon="svg/coins/chainlink.svg" value="3">Chainlink
                                </option>
