        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="/index" class="text-muted text-hover-primary">Load</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href=""
                    class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-primary">Track Loads</a>
                <!--end::Secondary button-->
                <!--begin::Primary button-->
                <a href="/load/list" class="btn btn-sm fw-bold btn-primary">Browse Loads</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                    ...
                    <div class="card-body d-flex flex-column flex-center">
                        ...
                        <div class="mb-2">
                            ...
                            <h1 class="fw-semibold text-gray-800 text-center lh-lg">Quick form to
                                <br />
                                <span class="fw-bolder">Bid a New Load</span></h1>
                            <!--end::Title-->
                            <!--begin::Illustration-->
                        ...
                        <div class="card overflow-hidden h-md-50 mb-5 mb-xl-10">
                            ...
                            <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                ...
                                <div class="mb-4 px-9">
                                    ...
                                    <!--end::Statistics-->
                                    <!--begin::Description-->
                                    <span class="fs-6 fw-semibold text-gray-400">Total Load</span>
                                    <!--end::Description-->
                                </div>
                                <!--end::Statistics-->
                                <!--begin::Chart-->
                ...
                <div class="card card-flush h-lg-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-gray-800">Load History</span>
                            <span class="text-gray-400 mt-1 fw-semibold fs-6">59 Active Load</span>
                        </h3>
                        <!--end::Title-->
                        <!--begin::Toolbar-->
