...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <a href="/load/list" class="btn btn-sm fw-bold btn-primary">Load Board</a>
        <!--end::Primary button-->
    </div>
    <!--end::Actions-->
</div>
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10">
                            ...
                            <!--begin::Input-->
                            <input type="text" class="form-control mb-2" name="meta_title"
                                placeholder="GHS 30,000.00" />
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">This amount is what has been agreed
                                with the broker to transport the load</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Input group-->
