            ...
            <div class="card card-flush">
                ...
                <form action="{{ route('broker.loads.assign') }}" method="post">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                <input class="form-check-input" name="loads[]" type="checkbox" value="{{$load->mask}}" />
                                            </div>
                                        </td>
                                        <td>{{ $load->mask }}</td>
                    ...
                    <div class="card-footer">
                        <h3 for="">Assign checked loads to organization</h3>
                        <div class="d-flex w-35" wire:ignore>
                            <select name="organization_id" class="form-control js-example-basic-single w-25" id="">
