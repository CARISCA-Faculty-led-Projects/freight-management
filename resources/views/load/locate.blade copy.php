        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a data-bs-toggle="modal"
                    ...
                    class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-primary">Reassign</a>
                <!--end::Secondary button-->
            </div>
            <!--end::Actions-->
        </div>
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body pt-15">
                        ...
                        <div class="d-flex flex-center flex-column mb-5">
                            ...
                            <!--end::Name-->
                            <!--begin::Email-->
                            <a href="#" class="fs-5 fw-semibold text-muted text-hover-primary mb-6">sender@gmail.com</a>
                            <!--end::Email-->
                        </div>
                        <!--end::Summary-->
                        ...
                        <div class="pb-5 fs-6">
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Load ID</div>
                            <div class="text-gray-600">ID-45453423</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Payment Status</div>
                            <div class="badge badge-success d-inline">Paid</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            ...
                            <div class="text-gray-600">104 Collin Street,
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="text-center mb-13">
                    ...
                    <div class="text-muted fw-semibold fs-5">Reassign load to a driver</div>
                </div>
                <!--end::Content-->
                 <!--begin::Search-->
