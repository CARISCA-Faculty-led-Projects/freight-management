...
@section('content')
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="/shipments/list" class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-primary">Browse
                    Shipments</a>
                                ...
                                <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <label for="kt_ecommerce_add_category_store_template"
                                                    class="form-label">Select a load type</label>
                                    ...
                                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                                    ...
                                                    <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
                                                        <div class="mb-10 flex-row-fluid position-relative">
                                                            ...
                                                            <input type="text" class="form-control mb-2"
                                                                name="meta_title" placeholder="eg. 1 Container" />
                                                            <!--end::Input-->
                                                            <!--begin::Description-->
                                                        ...
                                                        <div class="mb-10 flex-row-fluid position-relative">
                                                            ...
                                                            <!--begin::Input-->
                                                            <input type="text" class="form-control mb-2"
                                                                name="meta_title" placeholder="60" />
                                                            <!--end::Input-->
                                                            <!--begin::Description-->
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="form-check form-check-custom form-check-solid">
                                                            <input class="form-check-input" type="radio"
                                                                name="conditions" value="" id="all_conditions"
                                                                checked="checked" />
                                                            <label class="form-check-label"
                                                                for="all_conditions">Yes</label>
                                                        </div>

                                                        <div class="form-check form-check-custom form-check-solid">
                                                            <input class="form-check-input" type="radio"
                                                                name="conditions" value="" id="any_conditions" />
                                                            <label class="form-check-label"
                                                                for="any_conditions">No</label>
                                                        </div>
                                                    </div>
                                                    <!--end::Conditions-->
                                                    <!--begin::Repeater-->
                                                        ...
                                                        <div class="form-group">
                                                            <div data-repeater-list="kt_ecommerce_add_category_conditions"
                                                                ...
                                                                <div data-repeater-item=""
                                                                    ...
                                                                    <div class="w-100 w-md-200px">
                                                                        <select class="form-select"
                                                                            ...
                                                                            <option value="general_cargo"
                                                                                selected="selected">General Cargo
                                                                            </option>
                                                                            ...
                                                                            <option
                                                                                value="electronics_and_technology_products">
                                                                                Electronics and
                                                                                Technology Products</option>
                                                                            ...
                                                                            <option
                                                                                value="waste_and_recycling_materials">
                                                                                Waste and Recycling
                                                                                Materials</option>
                                                                    ...
                                                                    <input type="number"
                                                                        class="form-control mw-100 w-100px"
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <!--begin::Button-->
                                            <a href="/apps/ecommerce/catalog/products"
