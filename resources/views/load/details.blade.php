                ...
                <div class="timeline">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                <!--begin::Record-->
                                <div
                                    class="d-flex align-items-center bLoad bLoad-dashed bLoad-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                    <!--begin::Title-->
                                ...
                                <!--begin::Record-->
                                <div
                                    class="d-flex align-items-center bLoad bLoad-dashed bLoad-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                                    <!--begin::Title-->
                                    <a href="/apps/projects/project"
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                <div
                                    class="d-flex align-items-center bLoad bLoad-dashed bLoad-gray-300 rounded min-w-700px p-5">
                                    <!--begin::Item-->
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                <div
                                    class="d-flex align-items-center bLoad bLoad-dashed bLoad-gray-300 rounded min-w-700px p-7">
                                    <!--begin::Item-->
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                <!--begin::Notice-->
                                <div
                                    class="notice d-flex bg-light-primary rounded bLoad-primary bLoad bLoad-dashed min-w-lg-600px flex-shrink-0 p-6">
                                    <!--begin::Icon-->
                            ...
                            <div class="d-flex flex-stack pt-10">
                                ...
                                <div>
                                    <button type="button" class="btn btn-lg btn-primary"
                                        ...
                                        <span class="indicator-progress">Please wait...
                                            <span
                                                class="spinner-bLoad spinner-bLoad-sm align-middle ms-2"></span></span>
                                    </button>
                                    <button type="button" class="btn btn-lg btn-primary"
