		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			...
			<div class="d-flex flex-column flex-column-fluid">
				...
				<div class="bg-body d-flex flex-column-auto justify-content-cenrer align-items-start gap-2 gap-lg-4 py-4 px-10 overflow-auto" id="kt_app_header_nav">
					...
					<a href="/authentication/email/card-declined" class="btn btn-icon flex-column btn-text-gray-500 btn-icon-gray-300 btn-active-text-gray-700 btn-active-icon-gray-500 rounded-3 h-60px w-60px h-lg-90px w-lg-90px fw-semibold">
					...
					<a href="/authentication/email/promo-1" class="btn btn-icon flex-column btn-text-gray-500 btn-icon-gray-300 btn-active-text-gray-700 btn-active-icon-gray-500 rounded-3 h-60px w-60px h-lg-90px w-lg-90px fw-semibold active bg-light border border-2">
					...
					<a href="/authentication/email/promo-1?nav=0" class="flex-grow-1 text-end mt-2">
									...
									<tr>
										<td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
											...
											<div style="text-align:left; margin-bottom:54px">
												...
												<!--end:Text-->
												<!--begin:Action-->
												<a href="/pages/blog/post" target="_blank" style="background-color:#50cd89; margin-bottom: 70px; border-radius:6px;display:inline-block; margin-left:60px; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Arial,Helvetica,sans-serif;">Read Blog</a>
												<!--end:Action-->
												<!--begin:Media-->
												...
												<!--end:Text-->
												<!--begin:Action-->
												<a href="/pages/blog/post" target="_blank" style="background-color:#50cd89; border-radius:6px; display:inline-block; margin-left:60px; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Arial,Helvetica,sans-serif;">Read Blog</a>
												<!--end:Action-->
											</div>
											<!--end:Email content-->
										</td>
