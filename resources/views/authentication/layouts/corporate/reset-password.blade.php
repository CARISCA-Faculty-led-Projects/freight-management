				...
				<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
					...
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
						...
						<div class="w-lg-500px p-10">
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" id="kt_password_reset_form" data-kt-redirect-url="/authentication/layouts/corporate/new-password" action="#">
								<!--begin::Heading-->
								...
								<div class="d-flex flex-wrap justify-content-center pb-lg-0">
									...
									<a href="/authentication/layouts/corporate/sign-in" class="btn btn-light">Cancel</a>
								</div>
								<!--end::Actions-->
							</form>
							<!--end::Form-->
