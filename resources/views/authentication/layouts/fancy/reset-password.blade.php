				...
				<div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
					...
					<div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
						...
						<div class="d-flex flex-stack py-2">
							<!--begin::Back link-->
							<div class="me-2">
								<a href="/authentication/layouts/fancy/sign-in" class="btn btn-icon bg-light rounded-circle">
							...
							<div class="m-0">
								...
								<a href="/authentication/layouts/fancy/sign-in" class="link-primary fw-bold fs-5" data-kt-translate="password-reset-head-link">Sign In</a>
							</div>
							<!--end::Sign Up link=-->
						</div>
						<!--end::Header-->
						...
						<div class="py-20">
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" id="kt_password_reset_form" data-kt-redirect-url="/authentication/layouts/fancy/new-password" action="#">
								<!--begin::Heading-->
								...
								<div class="d-flex flex-stack">
									...
									<div class="m-0">
										...
										<a href="/authentication/layouts/fancy/sign-in" class="btn btn-lg btn-light-primary fw-bold" data-kt-translate="password-reset-cancel">Cancel</a>
									</div>
									<!--end::Link-->
								</div>
								<!--end::Actions-->
