<div class="">
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <!--end::Image input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">Set the image of the Driver. Only *.png, *.jpg and *.jpeg
                                    image
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="d-flex flex-wrap gap-5">
                                                ...
                                                <div class="fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" wire:model="driver.phone"
                                                        class="form-control mb-2" placeholder="Driver name"
                                                        value="" required />
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
                                            ...
                                            <div class="mt-10">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Editor-->
                                                <textarea id="kt_ecommerce_add_product_description" wire:model="driver.description"
                                                    class="min-h-200px mb-2 form-control"></textarea>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                                    ...
                                                    <tbody class="fs-6 fw-semibold text-gray-600">
                                                        <tr>
                                                            ...
                                                            <td><input type="email" wire:model="driver.email"
                                                                    class="form-control" disabled id=""></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Password</td>
                                                            <td>
    ...
    @include('partials.modals.password_change', ['type' => 'drivers', 'mask' => $this->driver['mask']])
</div>
