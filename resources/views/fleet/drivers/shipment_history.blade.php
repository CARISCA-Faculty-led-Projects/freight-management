                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                            ...
                            <tbody class="fw-bold text-gray-600">
                                <tr>
                                    ...
                                    <td>
                                        <a href="/apps/ecommerce/catalog/edit-product"
                                            class="text-dark text-hover-primary text-end">Edum, Kumasi <=> Tema, Accra</a>
                                    </td>
                                    <!--end::Item-->
                                    <!--begin::Product ID-->
                                    <!--end::Product ID-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/apps/ecommerce/catalog/edit-product"
                                            class="text-dark text-hover-primary text-end">Accra, Ghana <=> Gruie, Nigeria</a>
                                    </td>
                                    <!--end::Item-->
                                    <!--begin::Product ID-->
                                    <!--end::Product ID-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/apps/ecommerce/catalog/edit-product"
                                            class="text-dark text-hover-primary text-end">Accra, Ghana <=> Feeddet, Nigeria</a>
                                    </td>
                                    <!--end::Item-->
                                    <!--begin::Product ID-->
                                    <!--end::Product ID-->
                            ...
                            <div class="tab-content rounded h-100 bg-light p-10">
                                ...
                                <div class="tab-pane fade show active" id="kt_upgrade_plan_startup">
                                    ...
                                    <div class="pt-1">
                                        ...
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-7">
                                            <span class="fw-semibold fs-5 text-muted flex-grow-1">Drivering
                                                Module</span>
                                            <i class="ki-duotone ki-cross-circle fs-1">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                ...
                                <div class="tab-pane fade" id="kt_upgrade_plan_advanced">
                                    ...
                                    <div class="pt-1">
                                        ...
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-7">
                                            <span class="fw-semibold fs-5 text-gray-700 flex-grow-1">Drivering
                                                Module</span>
                                            <i class="ki-duotone ki-check-circle fs-1 text-success">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
