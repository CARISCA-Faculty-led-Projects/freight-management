                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{route('driver.shipment.loads.view',$shipment->mask)}}" class="menu-link px-3">View loads</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{route('driver.start-delivery',$shipment->mask)}}" onclick="return confirm('Confirm you are about to start delivery?')" class="menu-link px-3"
                                            >Start delivery</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
