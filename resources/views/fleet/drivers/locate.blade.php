        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="/fleet/drivers" class="text-muted text-hover-primary">Driver</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="/load/list" class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-primary">Load
                    Board</a>
                ...
                <!--end::Primary button-->
                <!--begin::Secondary button-->
                <a href="/fleet/drivers/edit"
                    class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-primary">Edit Driver</a>
                <!--end::Secondary button-->
                <!--begin::Secondary button-->
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body pt-15">
                        ...
                        <div class="d-flex flex-center flex-column mb-5">
                            ...
                            <!--end::Avatar-->
                            <!--begin::Name-->
                            <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1">#56545</a>
                            <!--end::Name-->
                            <!--begin::Email-->
                            <a href="#" class="fs-5 fw-semibold text-muted text-hover-primary mb-6">Jess Fleet
                                Management Inc</a>
                            <!--end::Email-->
                        </div>
                        <!--end::Summary-->
                        ...
                        <div class="pb-5 fs-6">
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Driver ID</div>
                            <div class="text-gray-600">ID-45453423</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Driver Name</div>
                            <div class="text-gray-600">Jonathan Koomson</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Driver Phone</div>
                            <div class="text-gray-600">+2336888989</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Assignment Status</div>
                            <div class="badge badge-success d-inline">Assigned</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Shipment Status</div>
                            <div class="badge badge-warning d-inline">On route</div>
                            <!--begin::Details item-->
                            <!--begin::Details toggle-->
                            ...
                            <div class="separator separator-dashed my-3"></div>
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Organization ID</div>
                            <a href="#" class="text-gray-600 text-hover-primary">#ORG-89893</a>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Assigned Load</div>
                            ...
                            <div class="text-gray-600">
                                <a href="#" class="text-gray-600 text-hover-primary">Refrigerated Goods</a>
                            </div>
                            <!--begin::Details item-->
                        ...
                        <div class="card pt-4 mb-6 mb-xl-9">
                            ...
                            <div class="card-body pt-0 pb-5">
                                <iframe
                                    ...
                                    width="100%" height="800" style="border:0;" allowfullscreen="true" Drivering="lazy"
                            ...
                            <div
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    ...
                                    <div class="fw-semibold">
                                        <div class="fs-6 text-gray-700">Please note that a valid phone number may be
                                            required for order or shipping rescheduling.</div>
                                    </div>
                                    <!--end::Content-->
                                </div>
                                <!--end::Wrapper-->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <div class="fw-bold d-flex flex-column justify-content-center mb-5">
                            <!--begin::Label-->
                            <div class="text-center mb-5" data-kt-add-auth-action="qr-code-label">DownDriver the
                                <a href="#">Authenticator app</a>, add a new account, then scan this barcode to set up
                                your account.</div>
                            <div class="text-center mb-5 d-none" data-kt-add-auth-action="text-code-label">DownDriver
                                the
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="text-center mb-13">
                    <h1 class="mb-3">Search Driver</h1>
                    <div class="text-muted fw-semibold fs-5">Reassign Driver to a driver</div>
                </div>
                <!--end::Content-->
                <!--begin::Search-->
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Emma
                                                Smith</a>
                                            <div class="fw-semibold text-muted">Jess Fleet Mangement Inc</div>
                                        </div>
                                        <!--end::Details-->
                                    </div>
                                    <!--end::Details-->
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <a href="#"
                                                ...
                                                Macy</a>
                                            <div class="fw-semibold text-muted">TopTier Trucks Co</div>
                                        </div>
                                        <!--end::Details-->
                                    </div>
                                    <!--end::Details-->
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Max
                                                Smith</a>
                                            <div class="fw-semibold text-muted">RiverDale Fleet Systems</div>
                                        </div>
                                        <!--end::Details-->
                                    </div>
                                    <!--end::Details-->
