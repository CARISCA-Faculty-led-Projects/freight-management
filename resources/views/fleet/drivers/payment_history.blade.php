                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5"
                                ...
                                <thead>
                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-75px">Payed Into</th>
                                        <th class="text-end min-w-100px">Shipment #</th>
                                    </tr>
                                </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end pe-0">
                                            <a href="/apps/ecommerce/sales/details"
                                                class="text-dark text-hover-primary">#SHP-0049053</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>985***2</td>
                                        ...
                                        <td class="text-end pe-0">
                                            <a href="/apps/ecommerce/sales/details"
                                                class="text-dark text-hover-primary">#SHP-0049343</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>985***4</td>
