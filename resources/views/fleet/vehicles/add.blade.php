        ...
        <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="tab-content">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="d-flex flex-wrap gap-5">
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <select class="form-select mb-2" name="tax" data-control="select2"
                                                ...
                                                <option></option>
                                                <option value="0">Jess Fleet Management Inc</option>
                                                <option value="0">TopTier Trucks Co</option>
                                                <option value="0">RiverDale Fleet Systems</option>
                                            </select>
                                            <!--end::Select2-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">Set the organization who owns the vehicle.
                                            </div>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Input group-->
                                    ...
                                    <div class="mb-10 fv-row mt-5">
                                        ...
                                        <!--end::Select2-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">A vehicle category is required and recommended to
                                    ...
                                    <div class="d-flex flex-wrap gap-5">
                                        ...
                                        <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <!--end::Select2-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">Set the year the vehicle was manufactured.
                                            </div>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="row row-cols-1 row-cols-md-3 row-cols-lg-1 row-cols-xl-3 g-9"
                                            ...
                                            <div class="col">
                                                ...
                                                <label
                                                    ...
                                                    <!--begin::Info-->
                                                    <span class="ms-5">
                                                        <span class="fs-4 fw-bold text-gray-800 d-block">Manual</span>
                                                    </span>
                                                    <!--end::Info-->
                                                </label>
                                                <!--end::Option-->
                                            ...
                                            <div class="col">
                                                ...
                                                <label
                                                    ...
                                                    <!--begin::Info-->
                                                    <span class="ms-5">
                                                        <span class="fs-4 fw-bold text-gray-800 d-block">Automatic
                                                        </span>
                                                    </span>
                                                    <!--end::Info-->
                                                </label>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="sku" class="form-control mb-2" placeholder="Name"
                                            value="" />
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="sku" class="form-control mb-2" placeholder="Email"
                                            value="" />
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                                ...
                                                <div data-repeater-list="kt_ecommerce_add_product_options"
                                                    ...
                                                    <div data-repeater-item=""
                                                        ...
                                                        <input type="text" class="form-control mw-100 w-200px"
                                                            name="product_option_value" placeholder="From" />
                                                        <!--end::Input-->
                                                        <=>
                                                            <!--begin::Input-->
                                                            <input type="text" class="form-control mw-100 w-200px"
                                                                name="product_option_value" placeholder="To" />
                                                            <!--end::Input-->
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid mb-2">
                                            ...
                                            <label class="form-check-label">Specify weight & height dimensions</label>
                                        </div>
                                        <!--end::Input-->
                                        <!--begin::Description-->
                    ...
                    <div class="tab-pane fade" id="kt_ecommerce_add_documents" role="tab-panel">
                        <div class="d-flex flex-column gap-7 gap-lg-10">
