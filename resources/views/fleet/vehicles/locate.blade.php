                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body pt-15">
                        ...
                        <div class="d-flex flex-center flex-column mb-5">
                            ...
                            <!--end::Name-->
                            <!--begin::Email-->
                            <a href="#" class="fs-5 fw-semibold text-muted text-hover-primary mb-6">Jess Fleet Management Inc</a>
                            <!--end::Email-->
                        </div>
                        <!--end::Summary-->
                        ...
                        <div class="pb-5 fs-6">
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Vehicle ID</div>
                            ...
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Load</div>
                            <div class="text-gray-600">#4544</div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                        ...
                        <div class="card pt-4 mb-6 mb-xl-9">
                            ...
                            <div class="card-body pt-0 pb-5">
                                <iframe
                                    ...
                                    width="100%" height="800" style="border:0;" allowfullscreen="true" Vehicleing="lazy"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <div class="fw-bold d-flex flex-column justify-content-center mb-5">
                            <!--begin::Label-->
                            <div class="text-center mb-5" data-kt-add-auth-action="qr-code-label">DownVehicle the
                                <a href="#">Authenticator app</a>, add a new account, then scan this barcode to set up
                                your account.</div>
                            <div class="text-center mb-5 d-none" data-kt-add-auth-action="text-code-label">DownVehicle the
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="text-center mb-13">
                    ...
                    <div class="text-muted fw-semibold fs-5">Reassign Vehicle to a driver</div>
                </div>
                <!--end::Content-->
                 <!--begin::Search-->
                    ...
                    <div class="py-5">
                        ...
                        <div data-kt-search-element="results" class="d-none">
                            ...
                            <div class="d-flex flex-center mt-15">
                                ...
                                <button type="submit" id="kt_modal_users_search_submit" class="btn btn-primary">Assign</button>
                            </div>
                            <!--end::Actions-->
                        </div>
                        <!--end::Results-->
