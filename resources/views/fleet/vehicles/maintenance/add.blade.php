...
<div class="container mt-5" id="kt_modal_add_maintenance_schedule" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
                ...
                <form id="kt_modal_add_maintenance_schedule_form" class="form" action="#">
                    ...
                    <div class="fv-row mb-8">
                        ...
                        <select class="form-select form-select-solid" data-control="select2" data-hide-search="true"
                            data-placeholder="Select an organization" name="status">
                            <option value=""></option>
                    ...
                    <div class="fv-row mb-8">
                        ...
                        <!--begin::Select2-->
                        <select class="form-select form-select-solid" data-control="select2" data-hide-search="true"
                            data-placeholder="Select an organization" name="provider">
                    ...
                    <div class="fv-row mb-8">
                        ...
                        <!--begin::Select2-->
                        <select class="form-select form-select-solid" data-control="select2" data-hide-search="true"
                            data-placeholder="Select an organization" name="frequency">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input type="date" class="form-control form-control-solid" name="date" placeholder="Enter Bid Amount"
                            name="bid_amount" />
                    </div>
                    <!--end::Input group-->
