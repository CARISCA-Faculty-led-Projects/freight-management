                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            {{-- <th class="min-w-125px">Load Capacity</th> --}}
                            {{-- <th class="min-w-125px">Status</th> --}}
                            <th class="min-w-125px">Assigned Driver</th>
                            <th class="min-w-125px">Owner</th>
                            {{-- <th class="min-w-125px">Maintenance Date</th> --}}
                            <th class="min-w-125px">GPS Status</th>
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        ...
                        <tr>
                            ...
                            {{-- <td>
                                <a href="#" class="text-gray-600 text-hover-primary mb-1">GR 5999 A</a>
                            </td>
                            <td>10 Tons</td> --}}
                            ...
                            {{-- <td>19 Oct 2024</td> --}}
                            <td><i class="badge badge-success">{{$vehicle->gps}}</i></td>
                            <td>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{route("vehicles.view",$vehicle->mask)}}" class="menu-link px-3">View</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{route("vehicles.edit",$vehicle->mask)}}" class="menu-link px-3">Edit</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{route("vehicles.delete",$vehicle->mask)}}" onclick="return confirm('Confirm you want to delete?')" class="menu-link px-3"
                                            >Delete</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
