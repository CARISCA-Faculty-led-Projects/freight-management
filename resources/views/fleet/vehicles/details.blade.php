                                ...
                                <div class="card pt-4 h-md-100 mb-6 mb-md-0">
                                    ...
                                    <div class="card-header border-0">
                                        ...
                                        <div class="card-title">
                                            <h2 class="fw-bold">Nissan Almero Giant X88</h2> <i
                                                class="badge badge-success"> Available</i>
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="fw-bold fs-2">
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-2">
                                                    <span class="text-muted fs-4 fw-semibold">Box Truck</span></div>
                                            </div>
                                        ...
                                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                            <tbody class="fw-semibold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">Nissan
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">Truck
                                                        <img src="assets/media/svg/card-logos/visa.svg"
                                                            class="w-50px ms-2" /></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">Almero Giant X88</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                    ...
                                                    <td class="fw-bold text-end">2015</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                    ...
                                                    <td class="fw-bold text-end">Blue</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                    ...
                                                    <td class="fw-bold text-end"><i
                                                            class="badge badge-success">Active</i></td>
                                                </tr>
                                        ...
                                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                            <tbody class="fw-semibold text-gray-600">
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">
                                                        <a href="/apps/invoices/view/invoice-3"
                                                            class="text-gray-600 text-hover-primary">#INV-000414.pdf</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">
                                                    ...
                                                    <td class="fw-bold text-end">
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary">roadworthy.pdf</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">
                                                    ...
                                                    <td class="fw-bold text-end">
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary">owner.pdf</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary">mransah_licence.pdf</a>
                                                    </td>
                                        ...
                                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                            <tbody class="fw-semibold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">Diesel
                                                        <img src="assets/media/svg/card-logos/visa.svg"
                                                            class="w-50px ms-2" /></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">Automatic
                                                        <img src="assets/media/svg/card-logos/visa.svg"
                                                            class="w-50px ms-2" /></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            <i class="ki-duotone ki-truck fs-2 me-2">
                                                                ...
                                                                <span class="path4"></span>
                                                                <span class="path5"></span>
                                                            </i>Axle Configuration</div>
                                                    </td>
                                                    <td class="fw-bold text-end">6 x 4</td>
                                                </tr>
                                        ...
                                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                            <tbody class="fw-semibold text-gray-600">
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">Jess Fleet Management Inc</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                    ...
                                                    <td class="fw-bold text-end">101 Collin Street,</br>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">+233 268977129</td>
                                                </tr>
                                        ...
                                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                            <tbody class="fw-semibold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end"><i
                                                            class="badge badge-dark">Automobile</i> <i
                                                            class="badge badge-dark">Heavy Equipment</i>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">10 Tons</td>
                                                </tr>
                                        ...
                                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                            <tbody class="fw-semibold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">Koforidua
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">Accra
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">Bolgatanga
