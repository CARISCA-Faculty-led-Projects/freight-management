                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_shipping_table">
                    <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-100px">Vehicle ID</th>
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        <tr>
                            ...
                            <td>
                                <a href="/apps/ecommerce/sales/details"
                                    class="text-dark text-hover-primary">Craftman Mechanics</a>
                            </td>
                            <td>GHS 300.00</td>
...
<tr>
    <td>
        <a href="/apps/ecommerce/sales/details" class="text-dark text-hover-primary">#ORG-0051208</a>
    </td>
    <td>
        <a href="/apps/ecommerce/sales/details" class="text-dark text-hover-primary">#VEH-876231</a>
    </td>
    <td>
        <!--begin::Badges-->
    ...
    <td>
        <a href="/apps/ecommerce/sales/details" class="text-dark text-hover-primary">AutoPro Services</a>
    </td>
    <td>GHS 150.00</td>
...
<tr>
    <td>
        <a href="/apps/ecommerce/sales/details" class="text-dark text-hover-primary">#ORG-0052356</a>
    </td>
    <td>
        <a href="/apps/ecommerce/sales/details" class="text-dark text-hover-primary">#VEH-332211</a>
    </td>
    <td>
        <!--begin::Badges-->
    ...
    <td>
        <a href="/apps/ecommerce/sales/details" class="text-dark text-hover-primary">QuickFix Auto Care</a>
    </td>
    <td>GHS 200.00</td>
...
<tr>
    <td>
        <a href="/apps/ecommerce/sales/details" class="text-dark text-hover-primary">#ORG-0053612</a>
    </td>
    <td>
        <a href="/apps/ecommerce/sales/details" class="text-dark text-hover-primary">#VEH-998877</a>
    </td>
    <td>
        <!--begin::Badges-->
    ...
    <td>
        <a href="/apps/ecommerce/sales/details" class="text-dark text-hover-primary">MaxTune Auto Solutions</a>
    </td>
    <td>GHS 120.00</td>
...
<tr>
    <td>
        <a href="/apps/ecommerce/sales/details" class="text-dark text-hover-primary">#ORG-0054823</a>
    </td>
    <td>
        <a href="/apps/ecommerce/sales/details" class="text-dark text-hover-primary">#VEH-765432</a>
    </td>
    <td>
        <!--begin::Badges-->
        <div class="badge badge-light-warning">In Progress</div>
    ...
    <td>
        <a href="/apps/ecommerce/sales/details" class="text-dark text-hover-primary">ProAuto Garage</a>
    </td>
    <td>GHS 180.00</td>
