...
@section('content')
  <!--begin::Wrapper-->
  <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper" style="height:50rem;">
    ...
    <div id="kt_header" class="header " data-kt-sticky="true" data-kt-sticky-name="header"
        ...
        <!--begin::Container-->
        <div class=" container d-flex align-items-stretch justify-content-between mt-3 mb-3"
            ...
            <div class="d-flex d-lg-none align-items-center flex-grow-1">
                ...
                <!--begin::Logo-->
                <a href="https://preview.keenthemes.com/rider-html-pro/index.html" class="d-lg-none">
                    <img alt="Logo"
                        src="https://preview.keenthemes.com/rider-html-pro/assets/media/logos/logo-compact.svg"
                        class="max-h-40px" />
                </a>
                <!--end::Logo-->
            </div>
        ...
        <div class="container-xxl" id="kt_content_container" >
            ...
            <div class="d-flex flex-column flex-lg-row">
                ...
                <div class="flex-column flex-lg-row-auto w-100 w-lg-300px w-xl-400px mb-10 mb-lg-0">
                    <!--begin::Contacts-->
                    <div class="card card-flush" style="height:60rem;">
                        <!--begin::Card header-->
                        ...
                        <!--begin::Card body-->
                        <div class="card-body pt-5" id="kt_chat_contacts_body" style="height:55rem;overflow:hidden;">
                            <!--begin::List-->
                            <div class="scroll-y me-n5 pe-5 h-700px h-lg-auto" data-kt-scroll="true"
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex flex-column align-items-end ms-2">
                                        ...
                                        <span
                                            class="badge badge-sm badge-circle badge-light-danger">5</span>
                                    </div>
                                    <!--end::Lat seen-->
                                </div>
                                <!--end::User-->
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Avatar-->
                                        <div class="symbol  symbol-45px symbol-circle "><img alt="Pic"
                                                src="http://localhost:8000/assets/media/avatars/300-23.jpg" /></div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                                            <a href="#"
                ...
                <div class="flex-lg-row-fluid ms-lg-7 ms-xl-10" >
                    <!--begin::Messenger-->
                    <div class="card" id="kt_chat_messenger" style="height:60rem;">
                        <!--begin::Card header-->
                        ...
                        <!--begin::Card body-->
                        <div class="card-body" id="kt_chat_messenger_body" style="height:55rem;overflow:hidden;">
                            <!--begin::Messages-->
                                    ...
                                    <div class="d-flex flex-column align-items-start">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                                    src="http://localhost:8000/assets/media/avatars/300-25.jpg" /></div>
                                            <!--end::Avatar-->
                                            <!--begin::Details-->
                                            <div class="ms-3">
                                                <a href="#"
                                ...
                                <div class="d-flex justify-content-end mb-10 ">
                                    ...
                                    <div class="d-flex flex-column align-items-end">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                                    src="http://localhost:8000/assets/media/avatars/300-1.jpg" /></div>
                                            <!--end::Avatar-->
                                        </div>
                                        <!--end::User-->
                                ...
                                <div class="d-flex justify-content-start mb-10 ">
                                    ...
                                    <div class="d-flex flex-column align-items-start">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <!--begin::Avatar-->
                                            <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                                    src="url('https://images.unsplash.com/photo-1718708382517-3e89131709a8?q=80&w=2030&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" /></div>
                                            <!--end::Avatar-->
                                            <!--begin::Details-->
                                            <div class="ms-3">
                                                <a href="#"
                        ...
                        <div class="card-footer pt-4" id="kt_chat_messenger_footer">
                            ...
                            <textarea class="form-control form-control-flush mb-3" rows="1"
                                data-kt-element="input" placeholder="Type a message">
                            </textarea>
                            <!--end::Input-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <button class="btn btn-sm btn-icon btn-active-light-primary me-1"
                                        type="button" data-bs-toggle="tooltip" title="Coming soon">
                                        <i class="ki-duotone ki-exit-up fs-3"><span
                                                class="path1"></span><span class="path2"></span></i>
                                    </button>
                                </div>
                                <!--end::Actions-->
                                ...
                                <div class="mh-375px scroll-y me-n7 pe-7">
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="url('https://images.unsplash.com/photo-1718708382517-3e89131709a8?q=80&w=2030&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" />
                                            </div>
                                            <!--end::Avatar-->
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic"
                                                    src="url('https://images.unsplash.com/photo-1718708382517-3e89131709a8?q=80&w=2030&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" />
                                            </div>
                                            <!--end::Avatar-->
                                ...
                                <div class="py-5">
                                        ...
                                        <div class="mh-375px scroll-y me-n7 pe-7">
                                            ...
                                            <div class="rounded d-flex flex-stack bg-active-lighten p-4"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="http://localhost:8000/assets/media/avatars/300-1.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="rounded d-flex flex-stack bg-active-lighten p-4"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="http://localhost:8000/assets/media/avatars/300-5.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="rounded d-flex flex-stack bg-active-lighten p-4"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="http://localhost:8000/assets/media/avatars/300-25.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="rounded d-flex flex-stack bg-active-lighten p-4"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="http://localhost:8000/assets/media/avatars/300-9.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="rounded d-flex flex-stack bg-active-lighten p-4"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="http://localhost:8000/assets/media/avatars/300-23.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="rounded d-flex flex-stack bg-active-lighten p-4"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="http://localhost:8000/assets/media/avatars/300-12.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="rounded d-flex flex-stack bg-active-lighten p-4"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="http://localhost:8000/assets/media/avatars/300-13.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                            ...
                                            <div class="rounded d-flex flex-stack bg-active-lighten p-4"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="http://localhost:8000/assets/media/avatars/300-21.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                    ...
                                    <div data-kt-search-element="empty" class="text-center d-none">
                                        ...
                                        <div class="text-center px-5">
                                            <img src="http://localhost:8000/assets/media/illustrations/dozzy-1/1.png" alt=""
