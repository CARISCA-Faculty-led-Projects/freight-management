    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Sender
                    Billing</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="/" class="text-muted text-hover-primary">Sender</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="/senders/list" class="text-muted text-hover-primary">Jesse ANim</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Biling</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                            ...
                            <div class="mb-10">
                                ...
                                <div>
                                    <select class="form-select form-select-solid" data-kt-select2="true"
                                        data-placeholder="Select option" data-dropdown-parent="#kt_menu_641ac4362c46c"
                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex my-4">
                                <a href="#" class="btn btn-sm btn-danger me-2" id="kt_user_follow_button">
                                    ...
                                    <span class="indicator-label">Terminate</span>
                                    <!--end::Indicator label-->
                                ...
                                <a href="/senders/edit" class="btn btn-sm btn-primary me-3">Edit Sender</a>
                                <!--begin::Menu-->
                                <div class="me-0">
                        ...
                        <div class="d-flex flex-wrap flex-stack">
                            ...
                            <div class="d-flex flex-column flex-grow-1 pe-8">
                                ...
                                <div class="d-flex flex-wrap">
                                    <!--begin::Stat-->
                                    <div
                                        class="border border-gray-300 border-dashed rounded min-w-225px py-3 px-4 me-6 mb-3">
                                        <!--begin::Number-->
                                        ...
                                        <!--end::Number-->
                                        <!--begin::Label-->
                                        <div class="fw-semibold fs-6 text-gray-400">Payments</div>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Stat-->
                                    <!--begin::Stat-->
                                    <div
                                        ...
                                        <!--end::Number-->
                                        <!--begin::Label-->
                                        <div class="fw-semibold fs-6 text-gray-400">Shipments</div>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Stat-->
                                    <!--begin::Stat-->
                                    <div
                                        ...
                                        <!--end::Number-->
                                        <!--begin::Label-->
                                        <div class="fw-semibold fs-6 text-gray-400">Brokages</div>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Stat-->
                                </div>
        ...
        <div class="card mb-5 mb-xl-10">
                    ...
                    <ul class="nav nav-stretch nav-line-tabs border-transparent" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a id="kt_billing_creditcard_tab" class="nav-link fs-5 fw-bold me-5 active"
                                data-bs-toggle="tab" role="tab" href="#kt_billing_creditcard">Credit / Debit Card</a>
                        </li>
                        <!--end::Tab item-->
                        <!--begin::Tab item-->
                        <li class="nav-item" role="presentation">
            ...
            <div id="kt_billing_payment_tab_content" class="card-body tab-content">
                ...
                <div id="kt_billing_paypal" class="tab-pane fade" role="tabpanel"
                    ...
                    <!--end::Title-->
                    <!--begin::Description-->
                    <div class="text-gray-600 fs-6 fw-semibold mb-5">To use PayPal as your payment method, you will need
                        to make pre-payments each month before your bill is due.</div>
                    <!--end::Description-->
                    <!--begin::Form-->
                    <form class="form">
                        <!--begin::Input group-->
                                        ...
                                        <span class="d-flex">
                                            ...
                                            <span class="ms-4">
                                                <span class="fs-3 fw-bold text-gray-900 mb-2 d-block">Personal
                                                    Deal</span>
                                                <span class="fw-semibold fs-4 text-muted">If you need more info, please
                                                    check it out</span>
                                            </span>
                                            <!--end::Info-->
                                        </span>
                                            ...
                                            <label
                                                ...
                                                <span class="ms-5">
                                                    <span class="fs-4 fw-bold text-gray-800 mb-2 d-block">Precise
                                                        Usage</span>
                                                    <span class="fw-semibold fs-7 text-gray-600">Withdraw money to your
