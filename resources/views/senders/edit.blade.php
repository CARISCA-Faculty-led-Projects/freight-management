            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Sender</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
            ...
            <div id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <!--end::Image input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">Set the image of the Sender. Only *.png, *.jpg and *.jpeg image
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-n2">
                        ...
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4 {{ $billing ? 'active' : '' }}"
                                wire:click="activate('billing')" data-bs-toggle="tab"
                    ...
                    <div class="tab-content">
                        ...
                        <form wire:submit.prevent="general" method="post" class="{{ $general ? '' : 'd-none' }}">
                            <div class="tab-pane fade {{ $general ? 'show active' : '' }}"
                                ...
                                <div class="d-flex flex-column gap-7 gap-lg-10">
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="text-muted fs-7">Set the organization the Sender is affiliated to.
                                        </div>
                                        <div class="d-none mt-10">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" wire:model="sender.name"
                                                    class="form-control mb-2" placeholder="Sender name"
                                                    value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="d-flex flex-wrap gap-5">
                                                ...
                                                <div class="fv-row w-100 flex-md-root">
                                                    <label class="required form-label">Sender Phone</label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="tel" wire:model="sender.phone"
                                                        class="form-control mb-2" placeholder="02X XXX XXXX"
                                                        value="" />
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
                                                    <div class="text-muted fs-7">Your phone number is required</div>
                                                    <!--end::Description-->
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Input group-->
                                                <div class="fv-row w-100 flex-md-root">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" wire:model="sender.email"
                                                        class="form-control mb-2" placeholder="Sender name"
                                                        value="" />
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
                                            ...
                                            <div class="mb-10 fv-row mt-10">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" wire:model="sender.address"
                                                    class="form-control mb-2" placeholder="Physical address"
                                                    value="" />
                                                <!--end::Input-->
                                                @error('address')
                                            ...
                                            <div class="mt-10">
                                                ...
                                                <textarea wire:model="sender.description" class="form-control" id="" cols="40" rows="10"></textarea>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                                <div class="text-muted fs-7">Write something small about the Sender.
                                                </div>
                                                <!--end::Description-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="fv-row mb-2">
                                                ...
                                                <div class="dropzone" id="kt_ecommerce_add_product_media">
                                                    ...
                                                    <div class="dz-message needsclick">
                                                        ...
                                                        <!--end::Icon-->
                                                        <input type="file" wire:model="sender.national_id"
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table align-middle table-row-dashed gy-5"
                                                    ...
                                                    <tbody class="fs-6 fw-semibold text-gray-600">
                                                        <tr>
                                                            <td>Email</td>
                                                            <td><input type="text" wire:model="sender.email"
                                                        ...
                                                        <tr>
                                                            <td>Password</td>
                                                            <td><button class="btn btn-sm btn-warning">Reset
                                                                    Password</button>
                                                            </td>
                            ...
                            <div class="{{ $general ? 'd-flex' : 'd-none' }} justify-content-end">
                                <!--begin::Button-->
                                <a href="{{ route('sender.overview') }}" id="kt_ecommerce_add_organization_cancel"
                        ...
                        <!--end::Tab pane-->
                        <!--begin::Tab pane-->
                        <form wire:submit.prevent="billing" method="post" class="{{ $billing ? '' : 'd-none' }}">
                            <div class="tab-pane fade {{ $billing ? 'show active' : '' }}"
