																...
																<div class="row">
																	...
																	<div class="col-lg-4 mb-6 mb-lg-0">
																		...
																		<div class="mb-0">
																			...
																			<div class="menu-item p-0 m-0">
																				<!--begin:Menu link-->
																				<a href="/utilities/modals/general/select-users" class="menu-link active">
												...
												<div class="menu-sub menu-sub-accordion">
													...
													<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
														...
														<div class="menu-sub menu-sub-accordion menu-active-bg">
															...
															<div class="menu-item">
																<!--begin:Menu link-->
																<a class="menu-link active" href="/utilities/modals/general/select-users">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Select Users</span>
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Select Friends</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_641ac43d614f3">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_641ac43d614f3" data-allow-clear="true">
																<option></option>
								...
								<div class="d-flex flex-stack pb-3">
									...
									<div class="d-flex">
										...
										<div class="ms-5">
											<!--begin::Name-->
											<div class="d-flex align-items-center">
												<a href="/pages/user-profile/overview" class="text-dark fw-bold text-hover-primary fs-5 me-4">Emma Smith</a>
												<!--begin::Label-->
								...
								<div class="d-flex flex-stack pb-3">
									...
									<div class="d-flex">
										...
										<div class="ms-5">
											<!--begin::Name-->
											<div class="d-flex align-items-center">
												<a href="/pages/user-profile/overview" class="text-dark fw-bold text-hover-primary fs-5 me-4">Sean Bean</a>
												<!--begin::Label-->
												<span class="badge badge-light-success d-flex align-items-center fs-8 fw-semibold">
												<i class="ki-duotone ki-star fs-8 text-success me-1"></i>Author</span>
												<!--end::Label-->
								...
								<div class="d-flex flex-stack pb-3">
									...
									<div class="d-flex">
										...
										<div class="ms-5">
											<!--begin::Name-->
											<div class="d-flex align-items-center">
												<a href="/pages/user-profile/overview" class="text-dark fw-bold text-hover-primary fs-5 me-4">Lusy Kunic</a>
												<!--begin::Label-->
												<span class="m-0"></span>
												<!--end::Label-->
											</div>
								...
								<div class="d-flex flex-stack pb-3">
									...
									<div class="d-flex">
										...
										<div class="ms-5">
											<!--begin::Name-->
											<div class="d-flex align-items-center">
												<a href="/pages/user-profile/overview" class="text-dark fw-bold text-hover-primary fs-5 me-4">Mat Dillon</a>
												<!--begin::Label-->
												<span class="m-0"></span>
												<!--end::Label-->
											</div>
