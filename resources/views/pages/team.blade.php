																...
																<div class="row">
																	...
																	<div class="col-lg-3 mb-6 mb-lg-0">
																		...
																		<div class="mb-6">
																			...
																			<div class="menu-item p-0 m-0">
																				<!--begin:Menu link-->
																				<a href="/pages/team" class="menu-link active">
								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion menu-sub-lg-down-indention">
										...
										<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-2 py-4 w-200px mh-75 overflow-auto">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link active" href="/pages/team">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Our Team</span>
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_641ac46432105">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_641ac46432105" data-allow-clear="true">
																<option></option>
									...
									<div class="card">
										...
										<div class="card-body p-lg-17">
												...
												<div class="mb-11">
													...
													<div class="overlay">
														...
														<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
															<a href="/pages/pricing/pricing-1" class="btn btn-primary">Pricing</a>
											...
											<div class="mb-18">
												...
												<div class="row row-cols-1 row-cols-sm-2 row-cols-xl-4 gy-10">
													...
													<div class="col text-center mb-9">
														...
														<div class="mb-0">
															<!--begin::Name-->
															<a href="/pages/user-profile/projects" class="text-dark fw-bold text-hover-primary fs-3">Paul Miles</a>
															<!--end::Name-->
															<!--begin::Position-->
													...
													<div class="col text-center mb-9">
														...
														<div class="mb-0">
															<!--begin::Name-->
															<a href="/pages/user-profile/projects" class="text-dark fw-bold text-hover-primary fs-3">Jania Garnbet</a>
															<!--end::Name-->
															<!--begin::Position-->
													...
													<div class="col text-center mb-9">
														...
														<div class="mb-0">
															<!--begin::Name-->
															<a href="/pages/user-profile/projects" class="text-dark fw-bold text-hover-primary fs-3">James Nilson</a>
															<!--end::Name-->
															<!--begin::Position-->
													...
													<div class="col text-center mb-9">
														...
														<div class="mb-0">
															<!--begin::Name-->
															<a href="/pages/user-profile/projects" class="text-dark fw-bold text-hover-primary fs-3">Mia Miles</a>
															<!--end::Name-->
															<!--begin::Position-->
													...
													<div class="col text-center mb-9">
														...
														<div class="mb-0">
															<!--begin::Name-->
															<a href="/pages/user-profile/projects" class="text-dark fw-bold text-hover-primary fs-3">Sophia Miles</a>
															<!--end::Name-->
															<!--begin::Position-->
													...
													<div class="col text-center mb-9">
														...
														<div class="mb-0">
															<!--begin::Name-->
															<a href="/pages/user-profile/projects" class="text-dark fw-bold text-hover-primary fs-3">Oliver Lucas</a>
															<!--end::Name-->
															<!--begin::Position-->
													...
													<div class="col text-center mb-9">
														...
														<div class="mb-0">
															<!--begin::Name-->
															<a href="/pages/user-profile/projects" class="text-dark fw-bold text-hover-primary fs-3">Amelia Miles</a>
															<!--end::Name-->
															<!--begin::Position-->
													...
													<div class="col text-center mb-9">
														...
														<div class="mb-0">
															<!--begin::Name-->
															<a href="/pages/user-profile/projects" class="text-dark fw-bold text-hover-primary fs-3">Liam James</a>
															<!--end::Name-->
															<!--begin::Position-->
															<div class="text-muted fs-6 fw-semibold">QA Managers</div>
															<!--begin::Position-->
											...
											<div class="text-center mb-20">
												...
												<!--end::Text-->
												<!--begin::Action-->
												<a href="/pages/careers/apply" class="btn btn-primary mb-5">Apply Now</a>
												<!--end::Action-->
											</div>
											<!--end::Join-->
											<!--begin::Card-->
