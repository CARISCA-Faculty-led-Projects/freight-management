																...
																<div class="row">
																	...
																	<div class="col-lg-3 mb-6 mb-lg-0">
																		...
																		<div class="mb-0">
																			...
																			<div class="menu-item p-0 m-0">
																				<!--begin:Menu link-->
																				<a href="/pages/social/feeds" class="menu-link active">
								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link active" href="/pages/social/feeds">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Feeds</span>
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Social Feeds</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_641ac403614ca">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_641ac403614ca" data-allow-clear="true">
																<option></option>
												...
												<div class="card-body pt-15 px-0">
													...
													<div class="d-flex flex-column text-center mb-9 px-9">
														...
														<div class="text-center">
															<!--begin::Name-->
															<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary fs-4">Jerry Kane</a>
															<!--end::Name-->
															<!--begin::Position-->
													...
													<div class="m-0">
														...
														<ul class="nav nav-pills nav-pills-custom flex-column border-transparent fs-5 fw-bold">
															...
															<li class="nav-item mt-5">
																<a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 active" href="/pages/social/feeds">
															...
															<!--begin::Nav item-->
															<li class="nav-item mt-5">
																<a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0" href="/pages/social/activity">
															...
															<!--begin::Nav item-->
															<li class="nav-item mt-5">
																<a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0" href="/pages/social/followers">
															...
															<!--begin::Nav item-->
															<li class="nav-item mt-5">
																<a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0" href="/pages/social/settings">
										...
										<div class="w-100 flex-lg-row-fluid mx-lg-13">
											...
											<div class="card card-flush mb-10">
												...
												<div class="card-footer d-flex justify-content-end pt-0">
													<!--begin::Post action-->
													<a href="/pages/blog/post" class="btn btn-sm btn-primary" id="kt_social_feeds_post_btn">
										...
										<div class="d-lg-flex flex-column flex-lg-row-auto w-lg-325px" data-kt-drawer="true" data-kt-drawer-name="end-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '250px': '300px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_social_end_sidebar_toggle">
												...
												<div class="card-body pt-5">
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															...
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-6 fw-bold">Jacob Jones</a>
																<span class="text-muted fw-semibold d-block fs-7">Barone LLC.</span>
															</div>
															<!--end:Author-->
															<!--begin:Action-->
															<a href="/pages/user-profile/overview" class="btn btn-sm btn-light fs-8 fw-bold">Follow</a>
															<!--end:Action-->
														</div>
														<!--end::Section-->
													</div>
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<!--begin:Author-->
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-6 fw-bold">Annette Black</a>
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<!--begin:Author-->
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-6 fw-bold">Devon Lane</a>
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<!--begin:Author-->
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-6 fw-bold">Kristin Watson</a>
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<!--begin:Author-->
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-6 fw-bold">Eleanor Pena</a>
											...
											<div class="card card-flush mb-5 mb-xl-8">
												...
												<div class="card-header pt-5">
													...
													<!--begin::Toolbar-->
													<div class="card-toolbar">
														<a href="/pages/social/activity" class="btn btn-sm btn-light">View All</a>
													</div>
													<!--end::Toolbar-->
												</div>
												<!--end::Header-->
