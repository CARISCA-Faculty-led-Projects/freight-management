																...
																<div class="row">
																	...
																	<div class="col-lg-3 mb-6 mb-lg-0">
																		...
																		<div class="mb-6">
																			...
																			<div class="menu-item p-0 m-0">
																				<!--begin:Menu link-->
																				<a href="/pages/about" class="menu-link active">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_641ac463809f3">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_641ac463809f3" data-allow-clear="true">
																<option></option>
												...
												<div class="mb-10">
													...
													<div class="overlay">
														...
														<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
															<a href="/pages/pricing/pricing-2" class="btn btn-primary">Pricing</a>
											...
											<div class="card bg-light mb-18">
												...
												<div class="card-body py-15">
													...
													<div class="fs-2 fw-semibold text-muted text-center">
														<a href="/account/security" class="link-primary fs-4 fw-bold">Marcus Levy</a>
														...
														<div class="card-xl-stretch me-md-6">
															...
															<div class="m-0">
																...
																<div class="fs-6 fw-bold">
																	<!--begin::Author-->
																	<a href="/apps/projects/users" class="text-gray-700 text-hover-primary">Jane Miller</a>
																	<!--end::Author-->
																	<!--begin::Date-->
													...
													<div class="col-md-4">
														...
														<div class="card-xl-stretch mx-md-3">
															...
															<div class="m-0">
																...
																<div class="fs-6 fw-bold">
																	<!--begin::Author-->
																	<a href="/apps/projects/users" class="text-gray-700 text-hover-primary">Cris Morgan</a>
																	<!--end::Author-->
																	<!--begin::Date-->
													...
													<div class="col-md-4">
														...
														<div class="card-xl-stretch ms-md-6">
															...
															<div class="m-0">
																...
																<div class="fs-6 fw-bold">
																	<!--begin::Author-->
																	<a href="/apps/projects/users" class="text-gray-700 text-hover-primary">Carles Nilson</a>
																	<!--end::Author-->
																	<!--begin::Date-->
