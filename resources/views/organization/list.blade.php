                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/apps/customers/view"
                                            class="text-gray-800 text-hover-primary mb-1">{{ $organization->name }}</a>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('org.details', $organization->mask) }}"
                                                    class="menu-link px-3">View</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('org.edit', $organization->mask) }}"
                                                    class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('admin.account.manage', ['type' => 'organizations', 'mask' => $organization->mask]) }}"
                                                    class="menu-link px-3">Manage</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('org.delete', $organization->mask) }}"
