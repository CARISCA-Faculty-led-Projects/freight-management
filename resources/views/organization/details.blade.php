														...
														<div class="menu-sub menu-sub-accordion">
															...
															<div class="menu-item">
																...
																<a class="menu-link" href="/apps/ecommerce/customers/listing">
																	...
																	<span class="menu-title">Organizations Listing</span>
																</a>
																<!--end:Menu link-->
															</div>
															<!--end:Menu item-->
															...
															<div class="menu-item">
																...
																<a class="menu-link" href="/apps/ecommerce/customers/details">
																	...
																	<span class="menu-title">Organizations Details</span>
																</a>
																<!--end:Menu link-->
															</div>
															<!--end:Menu item-->
														...
														<div class="menu-sub menu-sub-accordion">
															...
															<div class="menu-item">
																...
																<a class="menu-link" href="/apps/ecommerce/reports/customer-orders">
																	...
																	<span class="menu-title">Organization Orders</span>
																</a>
																<!--end:Menu link-->
															</div>
															<!--end:Menu item-->
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
													...
													<div class="menu-item">
														...
														<a class="menu-link" href="/apps/customers/list">
															...
															<span class="menu-title">Organization Listing</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
													...
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link active" href="/apps/customers/view">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
															<span class="menu-title">Organization Details</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
											...
											<div data-kt-search-element="wrapper">
												...
												<div data-kt-search-element="results" class="d-none">
													...
													<div class="scroll-y mh-200px mh-lg-350px">
														...
														<!--end::Item-->
														<!--begin::Category title-->
														<h3 class="fs-5 text-muted m-0 pt-5 pb-5" data-kt-search-element="category-title">Organizations</h3>
														<!--end::Category title-->
														<!--begin::Item-->
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															<!--begin::Symbol-->
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Organization Details</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_641ac428c120d">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_641ac428c120d" data-allow-clear="true">
																<option></option>
														...
														<div class="card-body pt-0 pb-5">
															...
															<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
																...
																<tbody class="fs-6 fw-semibold text-gray-600">
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">3053-1634</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">9237-5022</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">3258-7741</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">1748-4995</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">1731-6039</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">5143-8199</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">3896-6041</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">2112-7002</a>
																		</td>
																		<td>
																			<span class="badge badge-light-warning">Pending</span>
																		</td>
																...
																<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
																	<tbody>
																		<tr>
																			...
																			<td>POST /v1/customer/c_641ac428c7c84/not_found</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoice/in_7305_2720/invalid</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoices/in_7949_6974/payment</td>
																			<td class="pe-0 text-end min-w-200px">20 Dec 2023, 10:30 am</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-success">200 OK</div>
																			</td>
																			<td>POST /v1/invoices/in_1254_1793/payment</td>
																			<td class="pe-0 text-end min-w-200px">10 Mar 2023, 6:05 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-success">200 OK</div>
																			</td>
																			<td>POST /v1/invoices/in_6282_9529/payment</td>
																			<td class="pe-0 text-end min-w-200px">20 Dec 2023, 11:30 am</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-success">200 OK</div>
																			</td>
																			<td>POST /v1/invoices/in_4282_2313/payment</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoices/in_6282_9529/payment</td>
																			<td class="pe-0 text-end min-w-200px">22 Sep 2023, 11:05 am</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-danger">500 ERR</div>
																			</td>
																			<td>POST /v1/invoice/in_7942_2771/invalid</td>
																			<td class="pe-0 text-end min-w-200px">20 Dec 2023, 2:40 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-danger">500 ERR</div>
																			</td>
																			<td>POST /v1/invoice/in_3228_3610/invalid</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/customer/c_641ac428c7c81/not_found</td>
															...
															<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
																<tbody>
																	...
																	<tr>
																		...
																		<span class="badge badge-light-info">In Progress</span></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2023, 11:30 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">Invoice
