        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="/organization/list"
                    class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-primary">Browse Organizations</a>
                <!--end::Secondary button-->
            </div>
            <!--end::Actions-->
        </div>
                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <!--end::Input group-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">Uploads documents about insurance coverage on cargo and
                                        vehicles</div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Card header-->
                        ...
                        <div
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                ...
                                <div class="fw-semibold">
                                    ...
                                    <div class="fs-6 text-gray-700">We are expecting the account information you will be
