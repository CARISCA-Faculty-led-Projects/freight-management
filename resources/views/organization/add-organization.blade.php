...
<div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="/index" class="text-muted text-hover-primary">Organization</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <!--begin::Form-->
        <form id="kt_ecommerce_add_organization_form" class="form d-flex flex-column flex-lg-row"
            ...
            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body text-center pt-0">
                        ...
                        <!--end::Image input-->
                        <!--begin::Description-->
                        <div class="text-muted fs-7">Set the organization logo image. Only *.png, *.jpg and *.jpeg image
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <div class="rounded-circle bg-success w-15px h-15px" id="kt_ecommerce_add_organization_status">
                            </div>
                        </div>
                        <!--begin::Card toolbar-->
                    </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                            data-placeholder="Select an option" id="kt_ecommerce_add_organization_status_select">
                            <option></option>
                            <option value="published" selected="selected">Ghana</option>
                        ...
                        <div class="d-none mt-10">
                            <label for="kt_ecommerce_add_organization_status_datepicker" class="form-label">Select publishing
                                date and time</label>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                            data-placeholder="Select an option" id="kt_ecommerce_add_organization_status_select">
                            <option></option>
                            <option value="published" selected="selected">Greater Accra</option>
                            <option value="published">Ashanti Region</option>
                ...
                <!-- <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="text-muted fs-7 mb-7">Add organization to a category.</div>
                        ...
                        <input id="kt_ecommerce_add_organization_tags" name="kt_ecommerce_add_organization_tags"
                            class="form-control mb-2" value="" />
                        <div class="text-muted fs-7">Add tags to a organization.</div>
                    </div>
                </div> -->
                <!--end::Category & tags-->
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <label for="kt_ecommerce_add_organization_store_template" class="form-label">Select as many as apply</label>
                        ...
                        <!--begin::Item-->
													<div class="d-flex align-items-center mb-8 mt-5">
														...
														<!--begin::Description-->
														<div class="flex-grow-1">
															<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Harzardous Materials</a>
														</div>
													</div>
													<!--end:Item-->
                                                    <!--begin::Item-->
													...
													<div class="d-flex align-items-center mb-8 mt-5">
														...
														<!--begin::Description-->
														<div class="flex-grow-1">
															<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Automobile Tranport</a>
														</div>
													</div>
													<!--end:Item-->
                                                    <!--begin::Form group-->  
																		<div class="form-group mt-5">
																			<button type="button" data-repeater-create="" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_org_pref">
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="tab-content">
                    <!--begin::Tab pane-->
                    <div class="tab-pane fade show active" id="kt_ecommerce_add_organization_general" role="tab-panel">
                        <div class="d-flex flex-column gap-7 gap-lg-10">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">A organization name is required and recommended to be
                                            unique.</div>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div>
                                        ...
                                        <!--end::Editor-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Set a description to the organization for better
                                            visibility.</div>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Input group-->
														...
														<div class="card card-flush py-4">
															...
															<div class="card-body pt-0">
																...
																<div class="mb-10 fv-row">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="sku" class="form-control mb-2" placeholder="Organization Email" value="" />
																	<!--end::Input-->
																	<!--begin::Description-->
																...
																<div class="mb-10 fv-row">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="sku" class="form-control mb-2" placeholder="Organization Phone number" value="" />
																	<!--end::Input-->
																	<!--begin::Description-->
																...
																<div class="mb-10 fv-row">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="sku" class="form-control mb-2" placeholder="Organization Address" value="" />
																	<!--end::Input-->
																	<!--begin::Description-->
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <!--end::Input group-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">Upload the business registration documents here.</div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Card header-->
                            </div>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <!--end::Input group-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">Uploads documents about insurance coverage on cargo and vehicles</div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Card header-->
                            </div>
                    ...
                    <!--begin::Tab pane-->
                    <div class="tab-pane fade" id="kt_ecommerce_add_organization_advanced" role="tab-panel">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            <!--begin::Input group-->
                            <div class="" data-kt-ecommerce-catalog-add-organization="auto-options">
                                <!--begin::Label-->
                                        ...
                                        <div data-repeater-list="kt_ecommerce_add_organization_options"
                                            ...
                                            <div data-repeater-item=""
                                                ...
                                                <input type="text" class="form-control mw-100 w-300px"
                                                    name="organization_option_value" placeholder="From" />
                                                
                                                <input type="text" class="form-control mw-100 w-300px"
                                                    name="organization_option_value" placeholder="To" />
                                                <!--end::Input-->
                                    ...
                                    <!--begin::Pricing-->
												<div class="card card-flush pt-3 mb-5 mb-lg-10">
													...
													<div class="card-header">
														...
														<!--begin::Card toolbar-->
														<div class="card-toolbar">
															<button type="button" class="btn btn-light-primary">Add Vehicle</button>
														</div>
														<!--end::Card toolbar-->
													</div>
													<!--end::Card header-->
																...
																<tbody class="text-gray-600">
																	<tr>
                                                                        ...
                                                                        <td>
																			...
																			<!--begin::Delete-->
																			<a href="#" class="btn btn-icon btn-flex btn-active-light-primary w-30px h-30px me-3" data-bs-toggle="tooltip" title="Edit" data-kt-action="product_remove">
																			...
																			<!--end::Delete-->
																			<!--begin::Delete-->
																			<a href="#" class="btn btn-icon btn-flex btn-active-light-danger w-30px h-30px me-3" data-bs-toggle="tooltip" title="Delete" data-kt-action="product_remove">
                    ...
                    <div class="tab-pane fade" id="kt_ecommerce_biling_and_shipping_info" role="tab-panel">
                         <!--begin::Notice-->
														<div class="notice d-flex bg-light-warning rounded border-warning border border-dashed rounded-3 p-6">
															...
															<div class="d-flex flex-stack flex-grow-1">
																<!--begin::Content-->
																<div class="fw-semibold">
																	<h4 class="text-gray-900 fw-bold">Money will be charged from this account!</h4>
																	<div class="fs-6 text-gray-700">We are expecting the account information you will be using to pay for your subscriptions.
																	<a href="#" class="fw-bold">Learn more</a>.</div>
																</div>
																<!--end::Content-->
															</div>
												...
												<div class="card card-flush pt-3 mb-5 mb-lg-10 mt-10" data-kt-subscriptions-form="pricing">
													<!--begin::Card header-->
													<div class="card-header">
														<!--begin::Card title-->
														<div class="card-title">
                    ...
                    <div class="tab-pane fade" id="kt_ecommerce_payIn_account" role="tab-panel">
                         <!--begin::Notice-->
														<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed rounded-3 p-6">
															<!--begin::Wrapper-->
															<div class="d-flex flex-stack flex-grow-1">
																<!--begin::Content-->
																<div class="fw-semibold">
																	<h4 class="text-gray-900 fw-bold">Money will be paid into this account!</h4>
																	<div class="fs-6 text-gray-700">We are expecting the account information we can pay into for your fleet services.
																	<a href="#" class="fw-bold">Learn more</a>.</div>
																</div>
																<!--end::Content-->
															</div>
