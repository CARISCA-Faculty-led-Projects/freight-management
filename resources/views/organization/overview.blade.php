                ...
                <div class="col-xl-12 mb-5 mb-xl-10">
                    ...
                    <div class="row g-lg-5 g-xl-10">
                        ...
                        <div class="col-md-4 col-xl-4 mb-5 mb-xl-10">
                            ...
                            <div class="card h-md-100 card-flush mb-lg-10">
                                ...
                                <div class="card-body d-flex flex-column flex-center">
                                    ...
                                    <div class="d-flex me-7">
                                        <div id="kt_card_widget_10_chart" class="" style="height: 200px; width: 200px"
                                            data-kt-size="60" data-kt-line="13"></div>
                                    </div>
                                    <!--end::Chart-->
                                    <!--begin::Labels-->
                                    <div class="d-flex flex-column content-justify-start">
                                        <!--begin::Label-->
                        ...
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-3 col-xl-3 mb-xl-10">
                            ...
                            <div class="card overflow-hidden mb-5 mb-xl-10">
                                ...
                                <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                    ...
                                    <div class="mb-4 px-9">
                                        ...
                                        <!--end::Info-->
                                        <!--begin::Description-->
                                        <span class="fs-6 fw-semibold text-gray-400">Total Onl Sales</span>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Statistics-->
                                ...
                                <div class="tab-pane fade show active" id="kt_list_widget_10_tab_1">
                                        ...
                                        <div class="d-flex align-items-sm-center mb-5">
                                            ...
                                            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                                <div class="flex-grow-1 me-2">
                                                    <a href="#" class="text-gray-400 fs-6 fw-semibold">Ship
                                                        Freight</a>
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex align-items-sm-center mb-5">
                                            ...
                                            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                                <div class="flex-grow-1 me-2">
                                                    <a href="#" class="text-gray-400 fs-6 fw-semibold">Truck
                                                        Freight</a>
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex align-items-sm-center mb-5">
                                            ...
                                            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                                <div class="flex-grow-1 me-2">
                                                    <a href="#" class="text-gray-400 fs-6 fw-semibold">Plane
                                                        Freight</a>
                                                    <span class="text-gray-800 fw-bold d-block fs-4">#5635-342808</span>
                                                </div>
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-7 mb-3">
                            ...
                            <div class="card-toolbar">
                                <a href="#" class="btn btn-sm btn-light" data-bs-toggle='tooltip'
                                    data-bs-dismiss='click' data-bs-custom-class="tooltip-inverse"
                                    title="Logistics App is coming soon">Review
                                    Fleet</a>
                            </div>
                            <!--end::Toolbar-->
                        </div>
