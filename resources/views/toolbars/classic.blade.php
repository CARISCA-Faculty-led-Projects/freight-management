													...
													<div class="col-lg-6">
														...
														<div class="row">
															...
															<div class="col-lg-6 mb-3">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="/toolbars/classic" class="menu-link active">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
																		</span>
								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link active" href="/toolbars/classic">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Classic</span>
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Classic</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_641ac4737f2d9">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_641ac4737f2d9" data-allow-clear="true">
																<option></option>
												...
												<div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style="background-position: 100% 50%; background-image:url('assets/media/stock/900x600/42.png')">
													...
													<div class="mb-10">
														...
														<span class="position-relative d-inline-block text-danger">
															<a href="/pages/user-profile/overview" class="text-danger opacity-75-hover">Pro Plan</a>
															<!--begin::Separator-->
																			...
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Guy Hawkins</a>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jane Cooper</a>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jacob Jones</a>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Cody Fishers</a>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Brooklyn Simmons</a>
																						<span class="text-gray-400 fw-semibold d-block fs-7">Poland</span>
																					</div>
																				</div>
																			</td>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Esther Howard</a>
																						<span class="text-gray-400 fw-semibold d-block fs-7">Mexico</span>
																					</div>
																				</div>
																			</td>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Annette Black</a>
																						<span class="text-gray-400 fw-semibold d-block fs-7">Haiti</span>
																					</div>
																				</div>
																			</td>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Marvin McKinney</a>
																						<span class="text-gray-400 fw-semibold d-block fs-7">Monaco</span>
																					</div>
																				</div>
																			</td>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Ronald Richards</a>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Leslie Alexander</a>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Courtney Henry</a>
																						<span class="text-gray-400 fw-semibold d-block fs-7">Mexico</span>
																					</div>
																				</div>
																			</td>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Arlene McCoy</a>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Marvin McKinneyr</a>
																						<span class="text-gray-400 fw-semibold d-block fs-7">Monaco</span>
																					</div>
																				</div>
																			</td>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="/pages/user-profile/overview" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Ralph Edwards</a>
																						<span class="text-gray-400 fw-semibold d-block fs-7">Mexico</span>
																					</div>
																				</div>
																			</td>
														...
														<div class="col-sm-6">
															...
															<div class="d-flex flex-column h-100">
																	...
																	<div class="d-flex align-items-center flex-wrap d-grid gap-2">
																		...
																		<div class="d-flex align-items-center me-5 me-xl-13">
																			...
																			<div class="m-0">
																				...
																				<a href="/pages/user-profile/overview" class="fw-bold text-gray-800 text-hover-primary fs-7">Robert Fox</a>
																			</div>
																			<!--end::Info-->
																		</div>
																		<!--end::Item-->
																...
																<div class="d-flex flex-stack mt-auto bd-highlight">
																	...
																	<!--end::Users group-->
																	<!--begin::Actions-->
																	<a href="/apps/projects/project" class="d-flex align-items-center text-primary opacity-75-hover fs-6 fw-semibold">View Project
