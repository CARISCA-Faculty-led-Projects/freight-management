											...
											<div class="menu-state-bg menu-extended overflow-hidden overflow-lg-visible" data-kt-menu-dismiss="true">
												...
												<div class="row">
													...
													<div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
														...
														<div class="menu-item p-0 m-0">
															<!--begin:Menu link-->
															<a href="/dashboards/podcast" class="menu-link py-2 active">
									...
									<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-inner flex-column collapse show" id="kt_app_sidebar_menu_dashboards_collapse">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link active" href="/dashboards/podcast">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Podcast</span>
											...
											<div class="card flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100" style="background-color:#020202;background-image:url('assets/media/stock/600x600/img-62.jpg')">
												...
												<div class="card-body d-flex justify-content-between flex-column ps-xl-18">
													...
													<div class="mb-xl-10 mb-3">
														...
														<a href="/apps/support-center/overview" class="btn btn-color-white bg-transparent btn-outline fw-semibold" style="border: 1px solid rgba(255, 255, 255, 0.3)">Save for Later</a>
													</div>
													<!--begin::Action-->
												</div>
												<!--end::Body-->
										...
										<div class="col-xl-8">
											...
											<div class="card card-flush h-xl-100">
												...
												<div class="card-header pt-7">
													...
													<!--begin::Toolbar-->
													<div class="card-toolbar">
														<a href="/account/statements" class="btn btn-sm btn-light">History</a>
													</div>
													<!--end::Toolbar-->
												</div>
												<!--end::Header-->
												...
												<div class="card-body pt-6">
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															...
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Leslie Alexander</a>
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<!--begin:Author-->
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Jacob Jones</a>
																<span class="text-gray-400 fw-semibold d-block fs-6">Community</span>
															</div>
															<!--end:Author-->
															<!--begin::Follow-->
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<!--begin:Author-->
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Ronald Richards</a>
																<span class="text-gray-400 fw-semibold d-block fs-6">Community</span>
															</div>
															<!--end:Author-->
															<!--begin::Follow-->
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<!--begin:Author-->
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Courtney Henry</a>
																<span class="text-gray-400 fw-semibold d-block fs-6">Community</span>
															</div>
															<!--end:Author-->
															<!--begin::Follow-->
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<!--begin:Author-->
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Arlene McCoy</a>
																<span class="text-gray-400 fw-semibold d-block fs-6">Community</span>
															</div>
															<!--end:Author-->
															<!--begin::Follow-->
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<!--begin:Author-->
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Marvin McKinney</a>
																<span class="text-gray-400 fw-semibold d-block fs-6">Community</span>
															</div>
															<!--end:Author-->
															<!--begin::Follow-->
											...
											<div class="card h-md-100" dir="ltr">
												...
												<div class="card-body d-flex flex-column flex-center">
													...
													<div class="text-center mb-1">
														...
														<!--end::Link-->
														<!--begin::Link-->
														<a class="btn btn-sm btn-light" href="/account/billing">Learn More</a>
														<!--end::Link-->
													</div>
													<!--end::Links-->
												</div>
