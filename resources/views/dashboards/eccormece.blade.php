													...
													<div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
														...
														<div class="row">
															...
															<div class="col-lg-6 mb-3">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="/dashboards/ecommerce" class="menu-link active">
																		<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link active" href="/dashboards/ecommerce">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">eCommerce</span>
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<a href="/apps/ecommerce/sales/listing" class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-primary">Manage Sales</a>
										<!--end::Secondary button-->
										<!--begin::Primary button-->
										<a href="/apps/ecommerce/catalog/add-product" class="btn btn-sm fw-bold btn-primary">Add Product</a>
										<!--end::Primary button-->
									</div>
									<!--end::Actions-->
								</div>
																...
																<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
																	...
																	<tbody>
																		<tr>
																			...
																			<td class="ps-0">
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
																		...
																		<tr>
																			...
																			<td class="ps-0">
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
																		...
																		<tr>
																			...
																			<td class="ps-0">
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
																...
																<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
																	...
																	<tbody>
																		<tr>
																			...
																			<td class="ps-0">
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1324</a>
																...
																<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
																	...
																	<tbody>
																		<tr>
																			...
																			<td class="ps-0">
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 2635</a>
																				<span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-1523</span>
																			</td>
																			<td>
																				<span class="text-gray-800 fw-bold d-block fs-6 ps-0 text-end">x1</span>
																...
																<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
																	...
																	<tbody>
																		<tr>
																			...
																			<td class="ps-0">
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Nike</a>
																		...
																		<tr>
																			...
																			<td class="ps-0">
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Adidas</a>
																		...
																		<tr>
																			...
																			<td class="ps-0">
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Puma</a>
											...
											<div class="card h-md-100" dir="ltr">
												...
												<div class="card-body d-flex flex-column flex-center">
													...
													<div class="text-center mb-1">
														<!--begin::Link-->
														<a class="btn btn-sm btn-primary me-2" href="/apps/ecommerce/sales/listing">View App</a>
														<!--end::Link-->
														<!--begin::Link-->
														<a class="btn btn-sm btn-light" href="/apps/ecommerce/catalog/add-product">New Product</a>
														<!--end::Link-->
													</div>
													<!--end::Links-->
												</div>
												...
												<div class="card-body pt-2">
													...
													<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
														...
														<tbody class="fw-bold text-gray-600">
															...
															<tr>
																<td>
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary">#XGY-346</a>
																</td>
															...
															<tr>
																<td>
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary">#YHD-047</a>
																</td>
															...
															<tr>
																<td>
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary">#SRR-678</a>
																</td>
															...
															<tr>
																<td>
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary">#PXF-534</a>
																</td>
															...
															<tr>
																<td>
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary">#XGD-249</a>
																</td>
															...
															<tr>
																<td>
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary">#SKP-035</a>
																</td>
																<td class="text-end">2 day ago</td>
																<td class="text-end">
															...
															<tr>
																<td>
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary">#SKP-567</a>
																</td>
																<td class="text-end">7 min ago</td>
																<td class="text-end">
													...
													<div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
														...
														<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
															...
															<div class="d-flex flex-stack mb-3">
																...
																<div class="me-3">
																	...
																	<!--end::Icon-->
																	<!--begin::Title-->
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fw-bold">Elephant 1802</a>
																	<!--end::Title-->
																</div>
																<!--end::Wrapper-->
																<!--begin::Action-->
															...
															<div class="d-flex flex-stack">
																...
																<a href="/apps/ecommerce/sales/details" class="text-gray-800 text-hover-primary fw-bold">Jason Bourne</a></span>
																<!--end::Name-->
																<!--begin::Label-->
														...
														<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
															...
															<div class="d-flex flex-stack mb-3">
																...
																<div class="me-3">
																	...
																	<!--end::Icon-->
																	<!--begin::Title-->
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fw-bold">RiseUP</a>
																	<!--end::Title-->
																</div>
																<!--end::Wrapper-->
																<!--begin::Action-->
															...
															<div class="d-flex flex-stack">
																<!--begin::Name-->
																<span class="text-gray-400 fw-bold">To:
																<a href="/apps/ecommerce/sales/details" class="text-gray-800 text-hover-primary fw-bold">Marie Durant</a></span>
																<!--end::Name-->
																<!--begin::Label-->
														...
														<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
															...
															<div class="d-flex flex-stack mb-3">
																...
																<div class="me-3">
																	...
																	<!--end::Icon-->
																	<!--begin::Title-->
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fw-bold">Yellow Stone</a>
																	<!--end::Title-->
																</div>
																<!--end::Wrapper-->
																<!--begin::Action-->
															...
															<div class="d-flex flex-stack">
																<!--begin::Name-->
																<span class="text-gray-400 fw-bold">To:
																<a href="/apps/ecommerce/sales/details" class="text-gray-800 text-hover-primary fw-bold">Dan Wilson</a></span>
																<!--end::Name-->
																<!--begin::Label-->
														...
														<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
															...
															<div class="d-flex flex-stack">
																<!--begin::Name-->
																<span class="text-gray-400 fw-bold">To:
																<a href="/apps/ecommerce/sales/details" class="text-gray-800 text-hover-primary fw-bold">Lebron Wayde</a></span>
																<!--end::Name-->
																<!--begin::Label-->
																<span class="badge badge-light-success">Delivered</span>
																<!--end::Label-->
														...
														<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
															...
															<div class="d-flex flex-stack">
																<!--begin::Name-->
																<span class="text-gray-400 fw-bold">To:
																<a href="/apps/ecommerce/sales/details" class="text-gray-800 text-hover-primary fw-bold">Ana Simmons</a></span>
																<!--end::Name-->
																<!--begin::Label-->
																<span class="badge badge-light-primary">Shipping</span>
																<!--end::Label-->
														...
														<div class="border border-dashed border-gray-300 rounded px-7 py-3">
															...
															<div class="d-flex flex-stack">
																<!--begin::Name-->
																<span class="text-gray-400 fw-bold">To:
																<a href="/apps/ecommerce/sales/details" class="text-gray-800 text-hover-primary fw-bold">Kevin Leonard</a></span>
																<!--end::Name-->
																<!--begin::Label-->
																<span class="badge badge-light-danger">Confirmed</span>
																<!--end::Label-->
												...
												<div class="card-header pt-7">
													...
													<div class="card-toolbar">
														...
														<div class="d-flex flex-stack flex-wrap gap-4">
															...
															<!--end::Status-->
															<!--begin::Search-->
															<a href="/apps/ecommerce/catalog/products" class="btn btn-light btn-sm">View Stock</a>
															<!--end::Search-->
														</div>
														<!--begin::Filters-->
													</div>
													...
													<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
														...
														<tbody class="fw-bold text-gray-600">
															<tr>
																<!--begin::Item-->
																<td>
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-dark text-hover-primary">Macbook Air M1</a>
																</td>
																<!--end::Item-->
																<!--begin::Product ID-->
															...
															<tr>
																<!--begin::Item-->
																<td>
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-dark text-hover-primary">Surface Laptop 4</a>
																</td>
																<!--end::Item-->
																<!--begin::Product ID-->
															...
															<tr>
																<!--begin::Item-->
																<td>
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-dark text-hover-primary">Logitech MX 250</a>
																</td>
																<!--end::Item-->
																<!--begin::Product ID-->
															...
															<tr>
																<!--begin::Item-->
																<td>
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-dark text-hover-primary">AudioEngine HD3</a>
																</td>
																<!--end::Item-->
																<!--begin::Product ID-->
															...
															<tr>
																<!--begin::Item-->
																<td>
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-dark text-hover-primary">HP Hyper LTR</a>
																</td>
																<!--end::Item-->
																<!--begin::Product ID-->
															...
															<tr>
																<!--begin::Item-->
																<td>
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-dark text-hover-primary">Dell 32 UltraSharp</a>
																</td>
																<!--end::Item-->
																<!--begin::Product ID-->
																<td class="text-end">#XGY-356</td>
															...
															<tr>
																<!--begin::Item-->
																<td>
																	<a href="/apps/ecommerce/catalog/edit-product" class="text-dark text-hover-primary">Google Pixel 6 Pro</a>
																</td>
																<!--end::Item-->
																<!--begin::Product ID-->
