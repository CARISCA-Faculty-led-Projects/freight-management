											...
											<div class="menu-state-bg menu-extended overflow-hidden overflow-lg-visible" data-kt-menu-dismiss="true">
												...
												<div class="row">
													...
													<div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
														...
														<div class="menu-item p-0 m-0">
															<!--begin:Menu link-->
															<a href="/dashboards/school" class="menu-link py-2 active">
									...
									<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-inner flex-column collapse show" id="kt_app_sidebar_menu_dashboards_collapse">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link active" href="/dashboards/school">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">School</span>
											...
											<div class="card bg-primary h-xl-100">
												...
												<div class="card-body d-flex flex-column pt-13 pb-14">
													...
													<div class="text-center">
														...
														<!--end::Link-->
														<!--begin::Link-->
														<a class="btn btn-sm bg-white btn-color-white bg-opacity-20" href="/pages/careers/list">Nurse</a>
														<!--end::Link-->
													</div>
													<!--end::Links-->
												</div>
