													...
													<div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
														...
														<div class="row">
															...
															<div class="col-lg-6 mb-3">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="/dashboards/online-courses" class="menu-link active">
																		<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link active" href="/dashboards/online-courses">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													...
													<h3 class="card-title align-items-start flex-column text-white pt-15">
														...
														<div class="fs-4 text-white">
															...
															<span class="position-relative d-inline-block">
																<a href="/pages/user-profile/projects" class="link-white opacity-75-hover fw-bold d-block mb-1">4 tasks</a>
																<!--begin::Separator-->
												...
												<div class="card-body d-flex ps-xl-15">
													...
													<div class="m-0">
														...
														<span class="position-relative d-inline-block text-danger">
															<a href="/pages/user-profile/overview" class="text-danger opacity-75-hover">2300 bonus</a>
															<!--begin::Separator-->
														...
														<div class="mb-3">
															...
															<a href="/apps/support-center/overview" class="btn btn-color-white bg-white bg-opacity-15 bg-hover-opacity-25 fw-semibold">How to</a>
														</div>
														<!--begin::Action-->
													</div>
													<!--begin::Wrapper-->
												...
												<div class="card-body pt-6">
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															...
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-6 fw-bold">UI/UX Design</a>
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<!--begin:Author-->
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-6 fw-bold">QA Analysis</a>
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<!--begin:Author-->
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-6 fw-bold">Web Development</a>
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<!--begin:Author-->
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-6 fw-bold">Marketing</a>
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<!--begin:Author-->
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-6 fw-bold">Philosophy</a>
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<!--begin:Author-->
															<div class="flex-grow-1 me-2">
																<a href="/pages/user-profile/overview" class="text-gray-800 text-hover-primary fs-6 fw-bold">Mathematics</a>
																<span class="text-muted fw-semibold d-block fs-7">24+ Courses</span>
															</div>
															<!--end:Author-->
															<!--begin::Actions-->
