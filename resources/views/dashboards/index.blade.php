    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="/"
                    class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-primary">Browse Shipments</a>
                                ...
                                <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                    ...
                                    <div class="mb-4 px-9">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <!--begin::Label-->
                                            <span
                                                class="d-flex align-items-end text-gray-400 fs-6 fw-semibold">Tons</span>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Info-->
                                        <!--begin::Description-->
                                        ...
                                        <div class="timeline">
                                            ...
                                            <div class="timeline-item align-items-center">
                                                ...
                                                <div class="timeline-content m-0">
                                                    <!--begin::Title-->
                                                    <span
                                                        class="fs-6 text-gray-400 fw-semibold d-block">Forest-Midi</span>
                                                    <!--end::Title-->
                                                    <!--begin::Title-->
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex align-items-sm-center mb-5">
                                            ...
                                            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                                                ...
                                                <span
                                                    class="badge badge-lg badge-light-danger fw-bold my-2">Delayed</span>
                                            </div>
                                            <!--end::Section-->
                                        </div>
                                        <!--end::Wrapper-->
