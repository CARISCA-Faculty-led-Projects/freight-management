    ...
    <div class="modal-dialog modal-fullscreen p-9">
        ...
        <div class="modal-content modal-rounded">
            ...
            <div class="modal-body scroll-y m-5">
                <!--begin::Stepper-->
                <div class="stepper stepper-links d-flex flex-column" id="kt_modal_add_vehicle_stepper">
                    <!--begin::Container-->
                    <div class="container">
                        <!--begin::Nav-->
                        ...
                        <form class="mx-auto w-100 mw-600px pt-15 pb-10" novalidate="novalidate"
                            id="kt_modal_add_vehicle_form" method="post">
                            <!--begin::Type-->
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-8">
                                        <!--begin::Dropzone-->
                                        <div class="dropzone" id="kt_modal_add_vehicle_settings_logo">
                                            <!--begin::Message-->
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-8">
                                        ...
                                        <div class="position-relative w-lg-250px"
                                            id="kt_modal_add_vehicle_budget_setup" data-kt-dialer="true"
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-8">
                                        <!--begin::Dropzone-->
                                        <div class="dropzone" id="kt_modal_add_vehicle_files_upload">
                                            <!--begin::Message-->
                                            <div class="dz-message needsclick">
                                                <!--begin::Icon-->
                                                <i class="ki-duotone ki-file-up fs-3hx text-primary">
