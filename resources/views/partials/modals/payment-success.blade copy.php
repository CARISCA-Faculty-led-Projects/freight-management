...
<body>
    ...
    <div class="container-fluid">
        <div
            ...
            @else
                <img src="{{ asset('assets/media/gifs/failed.gif') }}" class="img-fluid" alt="">
            @endif
            <h3 class="display-4">HFD</h3>
            <h5 class="display-5">Kindly close this window and return to your previous page</h5>
        </div>
    </div>
