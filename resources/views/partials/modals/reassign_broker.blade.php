 ...
 <div class="modal fade" id="kt_modal_reassign_broker" tabindex="-1" aria-hidden="true">
     <!--begin::Modal dialog-->
     <div class="modal-dialog modal-dialog-centered mw-650px">
         ...
         <div class="modal-content">
             ...
             <div class="modal-header">
                 <!--begin::Modal title-->
                 <h2 class="fw-bold">Reassign Broker</h2>
                 <!--end::Modal title-->
                 <!--begin::Close-->
             ...
             <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                 ...
                 <div class="d-flex text-center mb-9">
                     <div class="w-50 border border-dashed border-gray-300 rounded mx-2 p-4">
                         <div class="fs-6 fw-semibold mb-2 text-muted">Earnings</div>
                         <div class="fs-2 fw-bold" kt-modal-adjust-balance="current_balance">GHS 32,487.57</div>
                     </div>
                     <div class="w-50 border border-dashed border-gray-300 rounded mx-2 p-4">
                         <div class="fs-6 fw-semibold mb-2 text-muted">Shipments
                         ...
                         <div class="fs-2 fw-bold" kt-modal-adjust-balance="new_balance">30</div>
                     </div>
                 </div>
                 <!--end::Balance preview-->
                 <!--begin::Form-->
                 <form id="kt_modal_adjust_balance_form" class="form" action="#">
                     ...
                     <div class="fv-row mb-7">
                         <!--begin::Label-->
                         <label class="required fs-6 fw-semibold form-label mb-2">Organization</label>
                         <!--end::Label-->
                         <!--begin::Dropdown-->
                         <select class="form-select form-select-solid fw-bold" name="adjustment"
                             ...
                             <option value="2">Logistics Plus Inc</option>
                             <option value="2">Swift Logistics Ltd</option>
                         </select>
                         <!--end::Dropdown-->
                     </div>
                     <!--end::Input group-->
                     ...
                     <div class="fv-row mb-7">
                         <!--begin::Label-->
                         <label class="fs-6 fw-semibold form-label mb-2">Add reassignment note</label>
                         <!--end::Label-->
                         <!--begin::Input-->
