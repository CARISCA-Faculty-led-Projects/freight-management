 ...
 <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
     ...
     <li class="nav-item mt-2">
         <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="/fleet/drivers/details">Personal
             Information</a>
     </li>
     <!--end::Nav item-->
     <!--begin::Nav item-->
     ...
     <!--begin::Nav item-->
     <li class="nav-item mt-2">
         <a class="nav-link text-active-primary ms-0 me-10 py-5" href="/fleet/drivers/driving_info">Driving Information</a>
     </li>
     <!--end::Nav item-->
     <!--begin::Nav item-->
     <!-- <li class="nav-item mt-2">
