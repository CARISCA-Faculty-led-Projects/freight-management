            ...
            <form class="d-flex flex-column flex-lg-row" method="POST"
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <!--begin::Card body-->
                        <div class="d-flex ms-auto me-auto mt-4 col-md-5 justify-self-center">
                            <!--begin::Payment address-->
                            <div class="card card-body d-flex  ">
                                <!--begin::Card header-->
                                {{-- <div class="text-center mb-5">
                                    <h2>Shipment Route <span class="spinner-border spinner-border-sm align-middle ms-2"
                                            wire:loading></span></h2>
                                </div> --}}
                                <!--end::Card header-->
                                {{-- Route selection --}}
                                {{-- @for ($r = 1; $r < count($locations) + 1; $r++)
                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label
                                            class="form-label">{{ $r == 1 ? 'Shipment starting point' : 'Stop #' . $r }}</label>
                                        <!--end::Label-->
                                        <select name="shipment_route[]" class="form-select stops" id="stos">
                                            <option value=""></option>
                                            @foreach ($locations as $location)
                                                <option value="{{ json_encode($location['position']) }}">
