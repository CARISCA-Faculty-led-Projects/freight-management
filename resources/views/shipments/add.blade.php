                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                            ...
                            <option></option>
                            <option value="pending" selected="selected">Pending</option>
                            <option value="approved">On route</option>
                            <option value="approved">Delivered</option>
                        </select>
                        <!--end::Select2-->
                        <!--begin::Description-->
                        <div class="text-muted fs-7">Set the shipment status.</div>
                        <!--end::Description-->
                        <!--begin::Datepicker-->
                        <div class="d-none mt-10">
                            <label for="kt_ecommerce_add_category_status_datepicker" class="form-label">Select
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                            ...
                            <option value="general_cargo" selected="selected">General Cargo
                            </option>
                            ...
                            <option value="flatbed_loads">Flatbed Loads</option>
                            <option value="overweight_cargo">Overweight Cargo</option>
                            <option value="automobile_transport">Automobile Transport</option>
                            <option value="livestock_transport">Livestock Transport</option>
                            <option value="perishable_goods">Perishable Goods</option>
                            <option value="fragile_goods">Fragile Goods</option>
                            <option value="construction_materials">Construction Materials
                            </option>
                            <option value="retail_goods">Retail Goods</option>
                            <option value="e_commerce_shipments">E-commerce Shipments</option>
                            <option value="pharmaceuticals_and_medical_supplies">Pharmaceuticals
                                and Medical Supplies</option>
                            <option value="agriculture_products">Agriculture Products</option>
                            <option value="textiles_and_apparel">Textiles and Apparel</option>
                            <option value="electronics_and_technology_products">Electronics and
                                Technology Products</option>
                            <option value="furniture_and_home_goods">Furniture and Home Goods
                            </option>
                            <option value="waste_and_recycling_materials">Waste and Recycling
                                Materials</option>
                            <option value="specialized_equipment">Specialized Equipment</option>
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                ...
                                <option></option>
                                <option value="default" selected="selected">Jonathan Adomako -
                                    +23389898989
                                </option>
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                data-placeholder="Select a sender" id="kt_ecommerce_add_category_store_template">
                                <option></option>
                                <option value="default" selected="selected">#45443
                                </option>
                                <option value="general_cargo">#54543
                                </option>
                                <option value="refrigerated_goods">#667676
                                </option>
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                data-placeholder="Select a sender" id="kt_ecommerce_add_category_store_template">
                                <option></option>
                                <option value="default" selected="selected">Jess Fleet Mangement Inc
                                </option>
                                <option value="general_cargo">TopTier Trucks Co
                                </option>
                                <option value="refrigerated_goods">RiverDale Fleet Systems
                                </option>
                            ...
                            <!--end::Select2-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">A sender organization is required and
                                recommended to be unique.</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                data-placeholder="Select a sender" id="kt_ecommerce_add_category_store_template">
                                <option></option>
                                <option value="default" selected="selected">Jesse Anim
                                </option>
                                <option value="general_cargo">Sandra Bullock
                                </option>
                                <option value="refrigerated_goods">Ashton Martin
                                </option>
                            ...
                            <!--end::Select2-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">A driver is required and
                                recommended to be unique.</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Input group-->
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
											...
											<div class="row">
												...
												<div class="col">
													<div class="card card-dashed flex-center min-w-175px my-3 p-6">
														<span class="fs-4 fw-semibold text-info pb-1 px-2">Budget</span>
												...
												<div class="col">
													<div class="card card-dashed flex-center min-w-175px my-3 p-6">
														<span class="fs-4 fw-semibold text-success pb-1 px-2">Agreed Amount</span>
                        ...
                        <div class="mb-10 fv-row mt-10">
                            <!--begin::Label-->
                            <label class="required form-label">Agreed Amount</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control mb-2" name="meta_title" placeholder="eg. 500" />
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">An agreed is required. This amount is
                        ...
                        <!--end::Input group-->
                            <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
                                ...
                                <div class="mb-10 flex-row-fluid position-relative">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control mb-2" name="meta_title" placeholder="60" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div>
                            <!--begin::Label-->
                            <label class="form-label mb-5">Load assignment method</label>
                            <!--end::Label-->
                            <!--begin::Methods-->
                            <!--end::Input row-->
                            <!--begin::Input row-->
                            <div class="d-flex fv-row">
                                ...
                                <div class="form-check form-check-custom form-check-solid">
                                    ...
                                    <label class="form-check-label" for="kt_ecommerce_add_category_automation_0">
                                        <div class="fw-bold text-gray-800">Assign Later</div>
                                        <div class="text-gray-600">Loads are added to load board
                                            unassigned</div>
                                    </label>
                                    <!--end::Label-->
                                </div>
                            ...
                            <div class="d-flex fv-row">
                                ...
                                <div class="form-check form-check-custom form-check-solid">
                                    ...
                                    <label class="form-check-label" for="kt_ecommerce_add_category_automation_0">
                                        ...
                                        <div class="text-gray-600">Loads are matched with an
                                            available driver from any organization willing to
                                            move load from pickup location
                                        </div>
                            ...
                            <div class="d-flex fv-row">
                                ...
                                <div class="form-check form-check-custom form-check-solid">
                                    ...
                                    <label class="form-check-label" for="kt_ecommerce_add_category_automation_1">
                                        ...
                                        <div class="text-gray-600">Assign load to a driver
                                            by manually selecting during load creation.</div>
                        ...
                        <div class="d-none mt-10" data-kt-ecommerce-catalog-add-category="auto-options">
                            ...
                            <!--begin::Conditions-->
                            <div class="d-flex flex-wrap align-items-center text-gray-600 gap-5 mb-7">
                                <span>Notify carrier organization:</span>
                                <!--begin::Radio-->
                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input" type="radio" name="conditions" value=""
                                        id="all_conditions" checked="checked" />
                                        ...
                                        <div data-repeater-item=""
                                            ...
                                            <div class="w-100 w-md-300px">
                                                <select class="form-select" name="condition_type"
                                                    data-placeholder="Select an option"
                                                    data-kt-ecommerce-catalog-add-category="condition_type">
                                                    <option selected='selected' default='default'>
                                                        Select Organization
                                                    </option>
                                                    <option value="title">Jess Fleet Mangement
                                                        Inc</option>
                                                    <option value="tag">TopTier Trucks Co
                                                    </option>
                                                    <option value="price">RiverDale Fleet
                                                        Systems</option>
                                                </select>
                                            </div>
                                            <!--end::Select2-->
                                            ...
                                            <div class="w-100 w-md-300px">
                                                <select class="form-select" name="condition_equals"
                                                    ...
                                                    <option value="equal" selected="selected">
                                                        #8898 - Mr. Nelson</option>
                                                    <option value="notequal">#89 - Daniel Smith
                                                    </option>
                                                    <option value="greater">#3 - Sampson
                                                    </option>
                                                </select>
                                            </div>
                                            <!--end::Select2-->
