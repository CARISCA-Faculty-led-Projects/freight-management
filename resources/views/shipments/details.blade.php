...
<div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted"> <a href="/shipments/list"
                            class="text-muted text-hover-primary">Shipment</a></li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-400 w-5px h-2px"></span>
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted"> <a href="/shipments/details"
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <div class="m-0">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                        ...
                        <div class="separator bShipment-gray-200"></div>
                        <!--end::Menu separator-->
                        <!--begin::Form-->
                        <div class="px-7 py-5">
                            <!--begin::Input group-->
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <!--begin::Shipment details page-->
        <div class="d-flex flex-column gap-7 gap-lg-10">
            <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
                <!--begin:::Tabs-->
                <ul
                    class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x bShipment-0 fs-4 fw-semibold mb-lg-n2 me-auto">
                    <!--begin:::Tab item-->
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab"
                            href="#kt_ecommerce_sales_Shipment_summary">Shipment Summary</a>
                    </li>
                    <!--end:::Tab item-->
                    <!--begin:::Tab item-->
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                            href="#kt_ecommerce_sales_Shipment_history">Shipment Breakdown</a>
                    </li>
                    <!--end:::Tab item-->
                    <!--begin:::Tab item-->
                    <!-- <li class="nav-item">
                ...
                <!--end::Button-->
                <!--begin::Button-->
                <a href="/shipments/edit" class="btn btn-success btn-sm me-lg-n7">Edit Shipment</a>
                <!--end::Button-->
                <!--begin::Button-->
                <!--begin::Button-->
                <a class="btn btn-primary btn-sm me-lg-n7"  data-bs-toggle="modal"
                    data-bs-target="#kt_modal_add_shipment">Add New Shipment</a>
                <!--end::Button-->
                <a class="btn btn-dark btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_adjust_balance">Initiate
                    Payment</a>
                <!--end::Button-->
            </div>
            <!--begin::Shipment summary-->
            <!--begin::Row-->
            ...
            <div class="tab-content">
                <!--begin::Tab pane-->
                <div class="tab-pane fade show active" id="kt_ecommerce_sales_Shipment_summary" role="tab-panel">
                    <!--begin::Shipments-->
                            ...
                            <div class="card card-flush py-4 flex-row-fluid">
                                ...
                                <div class="card-body pt-0">
                                    <div class="table-responsive">
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-bShipmented mb-0 fs-6 gy-5 min-w-300px">
                                        ...
                                        <table class="table align-middle table-row-bShipmented mb-0 fs-6 gy-5 min-w-300px">
                                            <tbody class="fw-semibold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">+6141 234 567
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">
                                                    ...
                                                    <td class="fw-bold text-end">House
                                                        3344,</br> Edum,</br> Kumasi</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
...
<div class="card mb-5 mb-xl-10">
										...
										<div class="card-body py-10">
											...
											<div class="row">
												...
												<div class="col">
													<div class="card card-dashed flex-center min-w-175px my-3 p-6">
														...
														<span data-kt-countup="true" data-kt-countup-value="70.00">0</span></span>
													</div>
												</div>
												<!--end::Col-->
												<!--begin::Col-->
											...
											<p class="fs-5 fw-semibold text-gray-600 py-6">
												Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam nemo commodi, impedit possimus eos repellendus ipsam accusantium, sed, dolores amet accusamus quis aut numquam veritatis quo a est tempore labore.
											</p>
											<!--end::Info-->
											<!--begin::Notice-->
                                                    ...
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span class="ms-1" data-bs-toggle="tooltip"
                                                                title="View the invoice generated by this Shipment.">
                                                                <i
                                                ...
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span class="ms-1" data-bs-toggle="tooltip"
                                                                title="View the shipping manifest generated by this Shipment.">
                                                                <i
                                                                    class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                                                    <span class="path1"></span>
                                                                    <span class="path2"></span>
                                                ...
                                                <tr>
                                                    <td class="text-muted">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span class="ms-1" data-bs-toggle="tooltip"
                                                                title="Reward value earned by customer when purchasing this Shipment">
                                                                <i
                                                                    class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                                                    <span class="path1"></span>
                                                                    <span class="path2"></span>
                                        ...
                                        <table class="table align-middle table-row-bShipmented mb-0 fs-6 gy-5 min-w-300px">
                                            <tbody class="fw-semibold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bold text-end">
                                                        <a href="#" class="text-gray-600 text-hover-primary">#4454</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-muted">
                ...
                <!--end::Tab pane-->
                <!--begin::Tab pane-->
                <div class="tab-pane fade" id="kt_ecommerce_sales_Shipment_history" role="tab-panel">
                    <!--begin::Shipments-->
                    <div class="d-flex flex-column gap-7 gap-lg-10">
...
<div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
    ...
    <div class="card shadow-none bShipment-0 rounded-0">
        <!--begin::Header-->
                ...
                <div class="timeline">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                <!--begin::Record-->
                                <div
                                    class="d-flex align-items-center bShipment bShipment-dashed bShipment-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                    <!--begin::Title-->
                                ...
                                <!--begin::Record-->
                                <div
                                    class="d-flex align-items-center bShipment bShipment-dashed bShipment-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                                    <!--begin::Title-->
                                    <a href="/apps/projects/project"
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                <div
                                    class="d-flex align-items-center bShipment bShipment-dashed bShipment-gray-300 rounded min-w-700px p-5">
                                    <!--begin::Item-->
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                <div
                                    class="d-flex align-items-center bShipment bShipment-dashed bShipment-gray-300 rounded min-w-700px p-7">
                                    <!--begin::Item-->
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="pe-3 mb-5">
                                <!--begin::Title-->
                                <div class="fs-5 fw-semibold mb-2">You have received a new Shipment:</div>
                                <!--end::Title-->
                                <!--begin::Description-->
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    <!--begin::Info-->
                            ...
                            <div class="overflow-auto pb-5">
                                <!--begin::Notice-->
                                <div
                                    class="notice d-flex bg-light-primary rounded bShipment-primary bShipment bShipment-dashed min-w-lg-600px flex-shrink-0 p-6">
                                    <!--begin::Icon-->
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mt-n1">
                            ...
                            <div class="pe-3 mb-5">
                                <!--begin::Title-->
                                <div class="fs-5 fw-semibold mb-2">New Shipment
...
<div id="kt_drawer_chat" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="chat" data-kt-drawer-activate="true"
    ...
    <!--begin::Messenger-->
    <div class="card w-100 bShipment-0 rounded-0" id="kt_drawer_chat_messenger">
        <!--begin::Card header-->
    ...
    <div class="card card-flush w-100 rounded-0">
        ...
        <div class="card-footer">
            ...
            <div class="d-flex justify-content-end mt-9">
                <a href="#" class="btn btn-primary d-flex justify-content-end">Pleace Shipment</a>
            </div>
            <!--end::Action-->
        </div>
        <!--end::Card footer-->
...
<div class="modal fade" id="kt_modal_upgrade_plan" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content rounded">
            <!--begin::Modal header-->
            <div class="modal-header justify-content-end bShipment-0 pb-0">
                <!--begin::Close-->
                ...
                <div class="d-flex flex-center flex-row-fluid pt-12">
                    ...
                    <button type="submit" class="btn btn-primary" id="kt_modal_upgrade_plan_btn">
                        ...
                        <span class="indicator-progress">Please wait...
                            <span class="spinner-bShipment spinner-bShipment-sm align-middle ms-2"></span></span>
                            ...
                            <div class="d-flex flex-stack pt-10">
                                ...
                                <div>
                                    <button type="button" class="btn btn-lg btn-primary"
                                        ...
                                        <span class="indicator-progress">Please wait...
                                            <span
                                                class="spinner-bShipment spinner-bShipment-sm align-middle ms-2"></span></span>
                                    </button>
                                    <button type="button" class="btn btn-lg btn-primary"
...
<div class="modal fade" id="kt_modal_users_search" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header pb-0 bShipment-0 justify-content-end">
                <!--begin::Close-->
                <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                    <i class="ki-duotone ki-cross fs-1">
                        <span class="path1"></span>
                ...
                <div id="kt_modal_users_search_handler" data-kt-search-keypress="true" data-kt-search-min-length="2"
                    ...
                    <form data-kt-search-element="form" class="w-100 position-relative mb-5" autocomplete="off">
                        ...
                        <span class="position-absolute top-50 end-0 translate-middle-y lh-0 d-none me-5"
                            ...
                            <span class="spinner-bShipment h-15px w-15px align-middle text-muted"></span>
                        </span>
                        <!--end::Spinner-->
                        <!--begin::Reset-->
                        <span
                    ...
                    <div class="py-5">
                        ...
                        <div data-kt-search-element="results" class="d-none">
                            ...
                            <div class="mh-375px scroll-y me-n7 pe-7">
                                ...
                                <!--end::User-->
                                <!--begin::Separator-->
                                <div class="bShipment-bottom bShipment-gray-300 bShipment-bottom-dashed"></div>
                                <!--end::Separator-->
                                <!--begin::User-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="mb-10">
                    ...
                    <div class="mh-300px scroll-y me-n7 pe-7">
                        <!--begin::User-->
                        <div class="d-flex flex-stack py-4 bShipment-bottom bShipment-gray-300 bShipment-bottom-dashed">
                            <!--begin::Details-->
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
