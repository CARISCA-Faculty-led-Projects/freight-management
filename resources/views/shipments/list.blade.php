                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_shipping_table">
                    <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-100px">Load ID</th>
                            ...
                            <th class="text-end min-w-100px">Assigned Carrier</th>
                            <th class="text-end min-w-100px">Assigned Driver</th>
                            <th class="text-end min-w-75px">Pickup date</th>
                            <th class="text-end min-w-100px">Delivery date</th>
                            <th class="text-end min-w-100px">Prize</th>
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        <tr>
                            ...
                            <td data-kt-ecommerce-order-filter="order_id" class="text-end">
                                <a href="/apps/ecommerce/sales/details"
                                    class="text-gray-800 text-hover-primary fw-bold">#898</a>
                            </td>
                            <td data-kt-ecommerce-order-filter="order_id" class="text-end">
                                <a href="/apps/ecommerce/sales/details"
                                    class="text-gray-800 text-hover-primary fw-bold">#34</a>
                            </td>
                            ...
                            <td class="text-end" data-order="2023-03-21">
                                <span class="fw-bold">GHS 34.00</span>
                            </td>
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="/shipments/details" class="menu-link px-3">View</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="/shipments/edit" class="menu-link px-3">Edit</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                        ...
                        <tr>
                            ...
                            <td data-kt-ecommerce-order-filter="order_id">
                                <a href="/apps/ecommerce/sales/details"
                                    class="text-gray-800 text-hover-primary fw-bold">#343</a>
                            </td>
                            ...
                            <td data-kt-ecommerce-order-filter="order_id" class="text-end">
                                <a href="/apps/ecommerce/sales/details"
                                    class="text-gray-800 text-hover-primary fw-bold">#987</a>
                            </td>
                            <td data-kt-ecommerce-order-filter="order_id" class="text-end">
                                <a href="/apps/ecommerce/sales/details"
                                    class="text-gray-800 text-hover-primary fw-bold">#65</a>
                            </td>
                            ...
                            <td class="text-end" data-order="2023-03-30">
                                <span class="fw-bold">GHS 210.00</span>
                            </td>
                            <td class="text-end">
                                <a href="#" class="btn btn-sm btn-light btn-flex btn-center btn-active-light-primary"
                                    data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
