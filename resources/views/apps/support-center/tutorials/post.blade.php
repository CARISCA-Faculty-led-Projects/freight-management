												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div class="menu-item">
																<!--begin:Menu link-->
																<a class="menu-link active" href="/apps/support-center/tutorials/post">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_641ac41bd1fbc">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_641ac41bd1fbc" data-allow-clear="true">
																<option></option>
											...
											<div class="card-rounded bg-light d-flex flex-stack flex-wrap p-5">
												...
												<ul class="nav flex-wrap border-transparent fw-bold">
													...
													<li class="nav-item my-1">
														<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="/apps/support-center/overview">Overview</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item my-1">
														<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="/apps/support-center/tickets/list">tickets</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item my-1">
														<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="/apps/support-center/tutorials/list">Tutorials</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item my-1">
														<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="/apps/support-center/faq">FAQ</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item my-1">
														<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="/apps/support-center/licenses">Licenses</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item my-1">
														<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="/apps/support-center/contact">Contact US</a>
													</li>
													<!--end::Nav item-->
												</ul>
												<!--end::Nav-->
												...
												<div class="flex-lg-row-fluid me-xl-15">
													...
													<div class="mb-17">
														...
														<div class="mb-8">
															...
															<div class="overlay mt-8">
																...
																<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
																	...
																	<a href="/pages/careers/apply" class="btn btn-light-primary ms-3">Join Us</a>
																</div>
																<!--end::Links-->
															</div>
															<!--end::Container-->
														...
														<div class="fs-5 fw-semibold text-gray-600">
															...
															<a href="/pages/blog/post" class="link-primary pe-1">Your Post</a>(yes, thinking counts as working if you’re a blogger) before you actually write it.</p>
															<!--end::Text-->
															<!--begin::Text-->
															...
															<a href="/pages/blog/home" class="link-primary pe-1">I mean NOTHING</a>– will kill a blog post more effectively than a lack of enthusiasm from the writer. You can tell when a writer is bored by their subject, and it’s so cringe-worthy it’s a little embarrassing.</p>
															<!--end::Text-->
															<!--begin::Text-->
														...
														<div class="d-flex align-items-center border-1 border-dashed card-rounded p-5 p-lg-10 mb-14">
															...
															<div class="text-center flex-shrink-0 me-7 me-lg-13">
																...
																<!--begin::Info-->
																<div class="mb-0">
																	<a href="/pages/user-profile/overview" class="text-gray-700 fw-bold text-hover-primary">Jane Johnson</a>
															...
															<div class="mb-0 fs-6">
																...
																<a href="/pages/user-profile/overview" class="fw-semibold link-primary">Author’s Profile</a>
															</div>
															<!--end::Text-->
														</div>
														<!--end::Block-->
												...
												<div class="row g-10">
													...
													<div class="col-md-4">
														...
														<div class="card-xl-stretch me-md-6">
															...
															<div class="m-0">
																<!--begin::Title-->
																<a href="/pages/user-profile/overview" class="fs-4 text-dark fw-bold text-hover-primary text-dark lh-base">Admin Panel - How To Started the Dashboard Tutorial</a>
																<!--end::Title-->
																<!--begin::Text-->
																...
																<div class="fs-6 fw-bold">
																	<!--begin::Author-->
																	<a href="/pages/user-profile/overview" class="text-gray-700 text-hover-primary">Jane Miller</a>
																	<!--end::Author-->
																	<!--begin::Date-->
													...
													<div class="col-md-4">
														...
														<div class="card-xl-stretch mx-md-3">
															...
															<div class="m-0">
																...
																<div class="fs-6 fw-bold">
																	<!--begin::Author-->
																	<a href="/pages/user-profile/overview" class="text-gray-700 text-hover-primary">Cris Morgan</a>
																	<!--end::Author-->
																	<!--begin::Date-->
													...
													<div class="col-md-4">
														...
														<div class="card-xl-stretch ms-md-6">
															...
															<div class="m-0">
																...
																<div class="fs-6 fw-bold">
																	<!--begin::Author-->
																	<a href="/pages/user-profile/overview" class="text-gray-700 text-hover-primary">Carles Nilson</a>
																	<!--end::Author-->
																	<!--begin::Date-->
