										...
										<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
											...
											<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
													...
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link active" href="/apps/subscriptions/view">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">View Subscriptions</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_641ac426aa4e5">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_641ac426aa4e5" data-allow-clear="true">
																<option></option>
																...
																<table class="table fs-6 fw-semibold gs-0 gy-2 gx-2 m-0">
																	...
																	<tr>
																		...
																		<td class="text-gray-800 min-w-200px">
																			<a href="/pages/apps/customers/view" class="text-gray-800 text-hover-primary">smith@kpmg.com</a>
																		</td>
																	</tr>
																	<!--end::Row-->
																	<!--begin::Row-->
														...
														<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
															<tbody>
																<tr>
																	...
																	<a href="#" class="fw-bold text-gray-800 text-hover-primary">1633-1216</a></td>
																	<td class="pe-0 text-gray-600 text-end min-w-200px">10 Nov 2023, 11:30 am</td>
																</tr>
																<tr>
																	<td class="min-w-400px">Invoice
																	<a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">6167-7095</a>status has changed from
																...
																<tr>
																	<td class="min-w-400px">Invoice
																	<a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">6145-9164</a>is
																...
																<tr>
																	<td class="min-w-400px">Invoice
																	<a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">9814-8894</a>status has changed from
										...
										<div class="flex-column flex-lg-row-auto w-lg-250px w-xl-300px mb-10 order-1 order-lg-2">
											...
											<div class="card card-flush mb-0" data-kt-sticky="true" data-kt-sticky-name="subscription-summary" data-kt-sticky-offset="{default: false, lg: '200px'}" data-kt-sticky-width="{lg: '250px', xl: '300px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
												...
												<div class="card-body pt-0 fs-6">
													...
													<!--begin::Actions-->
													<div class="mb-0">
														<a href="/apps/subscriptions/add" class="btn btn-primary" id="kt_subscriptions_create_button">Edit Subscription</a>
													</div>
													<!--end::Actions-->
												</div>
												<!--end::Card body-->
