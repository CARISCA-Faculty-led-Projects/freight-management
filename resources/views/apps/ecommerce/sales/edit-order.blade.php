												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
													...
													<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion menu-sub-indention">
														...
														<div class="menu-sub menu-sub-accordion">
															...
															<div class="menu-item">
																<!--begin:Menu link-->
																<a class="menu-link active" href="/apps/ecommerce/sales/edit-order">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
						...
						<div class="d-flex flex-column flex-column-fluid">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_641ac412bd3b2">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_641ac412bd3b2" data-allow-clear="true">
																<option></option>
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
									<form id="kt_ecommerce_edit_order_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="/apps/ecommerce/sales/listing">
										<!--begin::Aside column-->
										...
										<div class="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10">
															...
															<div class="row row-cols-1 row-cols-xl-3 row-cols-md-2 border border-dashed rounded pt-3 pb-1 px-2 mb-5 mh-300px overflow-scroll" id="kt_ecommerce_edit_order_selected_products">
																...
																<div class="col my-2" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_25">
																	<div class="d-flex align-items-center border border-dashed p-3 rounded bg-white">
																		...
																		<div class="ms-5">
																			<!--begin::Title-->
																			<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 25</a>
																			<!--end::Title-->
																			<!--begin::Price-->
																...
																<div class="col my-2" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_98">
																	<div class="d-flex align-items-center border border-dashed rounded p-3 bg-white">
																		...
																		<div class="ms-5">
																			<!--begin::Title-->
																			<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 98</a>
																			<!--end::Title-->
																			<!--begin::Price-->
																			<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_1">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 1</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_2">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 2</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_3">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 3</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_4">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 4</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_5">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 5</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_6">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 6</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_7">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 7</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_8">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 8</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_9">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 9</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_10">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 10</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																				<span data-kt-ecommerce-edit-order-filter="price">217.00</span></div>
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_11">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 11</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_12">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 12</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_13">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 13</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_14">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 14</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_15">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 15</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_16">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 16</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_17">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 17</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_18">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 18</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_19">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 19</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_20">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 20</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_21">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 21</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_22">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 22</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_23">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 23</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_24">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 24</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_26">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 26</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_27">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 27</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_28">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 28</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_29">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 29</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
																...
																<tr>
																	...
																	<td>
																		<div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_30">
																			...
																			<div class="ms-5">
																				<!--begin::Title-->
																				<a href="/apps/ecommerce/catalog/edit-product" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 30</a>
																				<!--end::Title-->
																				<!--begin::Price-->
																				<div class="fw-semibold fs-7">Price: $
											...
											<div class="d-flex justify-content-end">
												<!--begin::Button-->
												<a href="/apps/ecommerce/catalog/products" id="kt_ecommerce_edit_order_cancel" class="btn btn-light me-5">Cancel</a>
												<!--end::Button-->
												<!--begin::Button-->
