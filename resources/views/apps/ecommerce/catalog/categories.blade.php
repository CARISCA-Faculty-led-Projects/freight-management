												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div class="menu-item">
																<!--begin:Menu link-->
																<a class="menu-link active" href="/apps/ecommerce/catalog/categories">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_641ac40cc8a4a">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_641ac40cc8a4a" data-allow-clear="true">
																<option></option>
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																...
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="/apps/ecommerce/catalog/edit-category" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Computers</a>
																	<!--end::Title-->
																	<!--begin::Description-->
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																...
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="/apps/ecommerce/catalog/edit-category" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Watches</a>
																	<!--end::Title-->
																	<!--begin::Description-->
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																...
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="/apps/ecommerce/catalog/edit-category" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Headphones</a>
																	<!--end::Title-->
																	<!--begin::Description-->
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																...
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="/apps/ecommerce/catalog/edit-category" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Footwear</a>
																	<!--end::Title-->
																	<!--begin::Description-->
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																...
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="/apps/ecommerce/catalog/edit-category" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Cameras</a>
																	<!--end::Title-->
																	<!--begin::Description-->
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																...
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="/apps/ecommerce/catalog/edit-category" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Shirts</a>
																	<!--end::Title-->
																	<!--begin::Description-->
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																...
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="/apps/ecommerce/catalog/edit-category" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Household</a>
																	<!--end::Title-->
																	<!--begin::Description-->
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																...
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="/apps/ecommerce/catalog/edit-category" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Toys</a>
																	<!--end::Title-->
																	<!--begin::Description-->
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																...
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="/apps/ecommerce/catalog/edit-category" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Handbags</a>
																	<!--end::Title-->
																	<!--begin::Description-->
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																...
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="/apps/ecommerce/catalog/edit-category" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Wines</a>
																	<!--end::Title-->
																	<!--begin::Description-->
													...
													<tr>
														...
														<td>
															<div class="d-flex">
																...
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="/apps/ecommerce/catalog/edit-category" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Sandals</a>
																	<!--end::Title-->
																	<!--begin::Description-->
