    ...
    <div class="">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form @submit.prevent="addLoad" id="kt_ecommerce_add_category_form" method="POST"
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select class="form-select mb-2" data-hide-search="true"
                                    data-placeholder="Select an option" v-model="load.status"
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <!--begin::Select2-->
                                <select class="form-select mb-2" v-model="load.load_type" data-control="select2"
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Select2-->
                                    <select class="form-select mb-2 js-example-basic-single w-200" v-model="load.sender_id"
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <textarea v-model="load.description" class="min-h-100px mb-2 form-control" id="" cols="30"
                                        rows="4"></textarea>
                                    <!--begin::Description-->
                                    <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" class="form-control mb-2" v-model="load.budget"
                                        placeholder="eg. 500" />
                                    <!--end::Input-->
                                    <span class="text-danger">{{ $message }}</span>
                                    <!--begin::Description-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="d-flex flex-column gap-7 gap-lg-10">
                                    <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
                                        <div class="mb-10 flex-row-fluid position-relative">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="number" class="form-control mb-2" v-model="load.quantity"
                                        ...
                                        <div class="mb-10 flex-row-fluid position-relative">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="number" min="1" class="form-control mb-2" v-model="load.weight"
                                                placeholder="60" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                ...
                                <div class="d-flex flex-column gap-7 gap-lg-10">
                                    <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
                                        <div class="mb-10 flex-row-fluid position-relative">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="number" class="form-control mb-2" v-model="load.length"
                                                placeholder="eg. 12" />
                                            <!--end::Input-->
                                            @error('length')
                                            <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="mb-10 flex-row-fluid position-relative">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="number" min="1" class="form-control mb-2" v-model="load.breadth"
                                                placeholder="60" />
                                            <!--end::Input-->
                                            @error('breadth')
                                            <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="mb-10 flex-row-fluid position-relative">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="number" class="form-control mb-2" v-model="load.height"
                                                placeholder="60" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                ...
                                <div>
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Editor-->
                                    <input id="kt_ecommerce_add_category_meta_keywords" v-model="load.handling"
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="d-flex card-body pt-0 justify-content-between">
                                ...
                                <div class="mb-10 col-lg-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <select v-model="load.pickup_address" class="form-control" id="pickup_address">
                                ...
                                <div class="mb-10 col-lg-5">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <select v-model="load.dropoff_address" class="form-control" id="dropoff_address">
                                        <option value="">--select--</option>
                                    </select>
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mt-5">
                                    ...
                                    <div id="kt_ecommerce_add_category_conditions">
                                        <!--begin::Form group-->
                                        <div class="form-group mb-4" v-for="(item, index) in subloads" :key="index">
                                            <div data-repeater-list="kt_ecommerce_add_category_conditions"
                                                ...
                                                <div data-repeater-item=""
                                                    ...
                                                    <input type="text" class="form-control mw-100 w-200px"
                                                        v-model="subloads[index]['name']" placeholder="Item Name" />
                                                    <!--end::Input-->
                                                    <div class="w-100 w-md-200px">
                                                        <select class="form-select"
                                                            v-model="subloads[index]['load_type']"
                                                    ...
                                                    <input type="number" class="form-control mw-100 w-100px"
                                                        v-model="subloads[index]['quantity']" placeholder="Quantity" />
                                                    <!--end::Input-->
                                                    <!--begin::Input-->
                                                    <input type="number" class="form-control mw-100 w-200px"
                                                        v-model="subloads[index]['price']"
                                                        placeholder="Value eg. 120.00" />
                                                    <!--end::Input-->
                                                    <!--begin::Button-->
                                                    <button type="button" @click="delSub(index)"
                                        ...
                                        <div class="form-group mt-5">
                                            <!--begin::Button-->
                                            <button type="button" @click="addSubs" class="btn btn-sm btn-light-primary">
                                ...
                                <div class="fv-row mb-2">
                                    ...
                                    <div class="dropzone" id="kt_ecommerce_add_organization_media">
                                        ...
                                        <div class="dz-message needsclick">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <input type="file" name="insurance_docs" id="" class="form-control">
                                            <div class="ms-4">
                                ...
                                <div class="fv-row mb-2">
                                    ...
                                    <div class="dropzone" id="kt_ecommerce_add_organization_media">
                                        ...
                                        <div class="dz-message needsclick">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <input type="file" v-on:change="other" class="form-control" id="">
                                            <div class="ms-4">
                                                <h3 class="fs-7 fw-bold text-gray-900 mb-1">Drop files
                                                    here or click
                                                    to upload.</h3>
...
export default {
    data() {
        return {
            subloads: [
                { name: '', load_type: '', quantity: 0, value: '' },
            ],
            load:{},
            senders:null,
            load_types:{},
    ...
    mounted() {
        console.log('add load mounted.')
    },
    methods: {
        addLoad() {
            console.log(this.subloads);
        },
        addSubs() {
            this.subloads.push({ name: '', load_type: '', quantity: 0, value: '' });
        },
        delSub(index) {
            console.log(index);
            this.subloads.splice(index, 1);
        }
    }
}
</script>
